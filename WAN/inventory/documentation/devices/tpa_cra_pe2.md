...
| ------- | -------- | ---------- | ----- |
| nsho_provider_networks | TPA-TRX1-CRA2S-PE2 | All | Enabled |
| nsho_provider_networks | TPA-TRX1-CRA2S-PE2 |  | Enabled |
| nsho_provider_networks | TPA-TRX1-CRA2S-PE2 | bgp backward-transition, bridge | Disabled |

#### SNMP EngineID Configuration

| Type | EngineID (Hex) | IP | Port |
| ---- | -------------- | -- | ---- |
| local | 6a2cc7cfe5169b2e029cf37d042d5b7160d70f6b | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| NETSVC_NETBRAIN_TEST | READONLY | v3 | sha | aes | - | - | 6a2cc7cfe5169b2e029cf37d042d5b7160d70f6b |
| NETSVC_NETBRAIN | READONLY | v3 | sha | aes | - | - | 6a2cc7cfe5169b2e029cf37d042d5b7160d70f6b |
| SERVICENOW | READONLY | v3 | sha | aes | - | - | 6a2cc7cfe5169b2e029cf37d042d5b7160d70f6b |
| NETSVC_NETSCOUT | READONLY | v3 | sha | aes | - | - | 6a2cc7cfe5169b2e029cf37d042d5b7160d70f6b |
| NETSVC_SPECTRUM | READONLY | v3 | sha | aes | - | - | 6a2cc7cfe5169b2e029cf37d042d5b7160d70f6b |
| sdadmin | CAPC | v3 | md5 | - | - | - | 6a2cc7cfe5169b2e029cf37d042d5b7160d70f6b |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 6a2cc7cfe5169b2e029cf37d042d5b7160d70f6b
snmp-server contact nsho_provider_networks
snmp-server location TPA-TRX1-CRA2S-PE2
...
snmp-server user NETSVC_NETBRAIN_TEST READONLY v3 localized 6a2cc7cfe5169b2e029cf37d042d5b7160d70f6b auth sha <removed> priv aes <removed>
snmp-server user NETSVC_NETBRAIN READONLY v3 localized 6a2cc7cfe5169b2e029cf37d042d5b7160d70f6b auth sha <removed> priv aes <removed>
snmp-server user SERVICENOW READONLY v3 localized 6a2cc7cfe5169b2e029cf37d042d5b7160d70f6b auth sha <removed> priv aes <removed>
snmp-server user NETSVC_NETSCOUT READONLY v3 localized 6a2cc7cfe5169b2e029cf37d042d5b7160d70f6b auth sha <removed> priv aes <removed>
snmp-server user NETSVC_SPECTRUM READONLY v3 localized 6a2cc7cfe5169b2e029cf37d042d5b7160d70f6b auth sha <removed> priv aes <removed>
snmp-server user sdadmin CAPC v3 localized 6a2cc7cfe5169b2e029cf37d042d5b7160d70f6b auth md5 <removed>
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | MPLS_Overlay_peering | default | 10.199.1.28/32 |
...
| ---------- | --------- | ------------------------- | -------------------- | --- | ------- | ----------------------------- | ---------------------------- | ----------------------------- | ------------- | --------------------- | ------------------ |
| 64800 | 10.199.1.28 | disabled |- | enabled | 12000 | disabled | disabled | 1000000 | - | - | - |
...
| Sequence | Type | Match | Set | Sub-Route-Map | Continue |
| -------- | ---- | ----- | --- | ------------- | -------- |
| 10 | permit | - | community 64800:2 additive | - | - |

##### RO_MGMT_SW_OUT

| Sequence | Type | Match | Set | Sub-Route-Map | Continue |
| -------- | ---- | ----- | --- | ------------- | -------- |
| 10 | permit |  ip address prefix-list DEFAULT  | community 64800:2 additive | - | - |
...
| 10 | permit |  ip address prefix-list DEFAULT  | community 64800:1 additive<br>community 64800:2 additive | - | - |
...
| 50 | permit | community POLICY_LP170 | local-preference 170 | - | - |
| 60 | permit | community POLICY_LP180 | local-preference 180 | - | - |
| 70 | permit | community PE2 | local-preference 120 | - | - |
| 80 | permit | - | - | - | - |
