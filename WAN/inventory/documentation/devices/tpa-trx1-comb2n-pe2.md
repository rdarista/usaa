...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 10.9.181.2/24 | - |
...
| ---- | -------------- | -- | ---- |
| local | 47f92f977a5a5ec285e0898345ecd835398ec93d | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| NETSVC_NETBRAIN_TEST | READONLY | v3 | sha | aes | - | - | 47f92f977a5a5ec285e0898345ecd835398ec93d |
| NETSVC_NETBRAIN | READONLY | v3 | sha | aes | - | - | 47f92f977a5a5ec285e0898345ecd835398ec93d |
| SERVICENOW | READONLY | v3 | sha | aes | - | - | 47f92f977a5a5ec285e0898345ecd835398ec93d |
| NETSVC_SPECTRUM | READONLY | v3 | sha | aes | - | - | 47f92f977a5a5ec285e0898345ecd835398ec93d |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 47f92f977a5a5ec285e0898345ecd835398ec93d
...
snmp-server user NETSVC_NETBRAIN_TEST READONLY v3 localized 47f92f977a5a5ec285e0898345ecd835398ec93d auth sha <removed> priv aes <removed>
snmp-server user NETSVC_NETBRAIN READONLY v3 localized 47f92f977a5a5ec285e0898345ecd835398ec93d auth sha <removed> priv aes <removed>
snmp-server user SERVICENOW READONLY v3 localized 47f92f977a5a5ec285e0898345ecd835398ec93d auth sha <removed> priv aes <removed>
snmp-server user NETSVC_SPECTRUM READONLY v3 localized 47f92f977a5a5ec285e0898345ecd835398ec93d auth sha <removed> priv aes <removed>
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | MPLS_Overlay_peering | default | 10.199.0.43/32 |
...
| ---------- | --------- | ------------------------- | -------------------- | --- | ------- | ----------------------------- | ---------------------------- | ----------------------------- | ------------- | --------------------- | ------------------ |
| 64800 | 10.199.0.43 | disabled |- | enabled | 0 | disabled | disabled | 1000000 | - | - | - |
...
interface Port-Channel100
  description PE-PE:TPA-TRX1-COMB2N-PE1:Po100
  no switchport
  ip address 10.199.1.41/31
  mpls ldp interface
...
interface Ethernet11
  description PE-PE:TEMP To TPA-TRX1-TFLRO-PE2:Te0/1/2
  no shutdown
  mtu 9170
  no switchport
  ip address 10.199.1.26/31
  mpls ldp interface
...
interface Ethernet36
  description PE-PE:TPA-TRX1-CRA2S-PE2:Eth36:Lumen:CID#446719580
  no shutdown
  mtu 9170
  no switchport
  ip address 10.199.1.94/31
  mpls ldp interface
  mac security profile MKA_AES_256
  ip ospf cost 1000
  ip ospf network point-to-point
...
interface Ethernet37
  description P-PE:Level3:440351841:DFW-TRX1-DALEQ-P4:TenGigE0/0/0/8
  no shutdown
  mtu 9170
  no switchport
  ip address 10.199.1.15/31
  mpls ldp interface
  mac security profile MKA_AES_256
  ip ospf network point-to-point
  ip ospf authentication message-digest
...
interface Ethernet47
  description PE-PE:TPA-TRX1-COM-PE1:Eth47
  no shutdown
  no switchport
...
interface Ethernet48
  description PE-PE:TPA-TRX1-COM-PE1:Eth48
  no shutdown
  no switchport
  channel-group 100 mode active
  mac security profile MKA_AES_256
...
interface Ethernet49/1
  description PE-CE:TPA-UI1-COM-N1:Eth2/1
  no shutdown
  no switchport
!
interface Ethernet49/1.2020
  description PE-CE:TPA-UI1-COM-N1:Eth2/1.2020
  encapsulation dot1q vlan 2020
  vrf USX1
  ip address 10.49.158.4/31
  ip access-group ACL_RO_TRAFFIC_INBOUND in
!
interface Ethernet49/1.2820
  description PE-CE:TPA-UI1-COM-N1:Eth2/1.2820
  encapsulation dot1q vlan 2820
  vrf USUNT1
  ip address 10.111.124.68/31
!
interface Ethernet50/1
  description PE-CE:TPA-UI1-COM-N2:Eth2/1
  no shutdown
  no switchport
!
interface Ethernet50/1.2020
  description PE-CE:TPA-UI1-COM-N2:Eth2/1.2020
  encapsulation dot1q vlan 2020
  vrf USX1
  ip address 10.49.158.6/31
  ip access-group ACL_RO_TRAFFIC_INBOUND in
!
interface Ethernet50/1.2820
  description PE-CE:TPA-UI1-COM-N2:Eth2/1.2820
  encapsulation dot1q vlan 2820
  vrf USUNT1
  ip address 10.111.124.70/31
!
interface Ethernet51/1
  description PE-CE:TPA-OB1-COM-N1:Eth54/1
  no shutdown
  no switchport
  vrf OB1
  ip address 10.9.183.46/31
!
interface Loopback0
  description MPLS_Overlay_peering
  ip address 10.199.0.43/32
...
router bgp 64800
  ...
  neighbor PE_CE_OB1 remote-as 64906
  ...
  neighbor PE_CE_USUNT1 remote-as 64752
  ...
  neighbor PE_CE_USX1 remote-as 64752
  ...
  router-id 10.199.0.43
  maximum-paths 2 ecmp 2
  neighbor 10.9.183.47 peer group PE_CE_OB1
  neighbor 10.9.183.47 description OB1-N1:OB1
  !
  vrf USUNT1
  rd 10.199.0.43:911
  ...
  router-id 10.199.0.43
  maximum-paths 2 ecmp 2
  neighbor 10.111.124.69 peer group PE_CE_USUNT1
  neighbor 10.111.124.69 description UI1-N1:USUNT1
  neighbor 10.111.124.71 peer group PE_CE_USUNT1
  neighbor 10.111.124.71 description UI1-N2:USUNT1
  !
  vrf USX1
  rd 10.199.0.43:914
  ...
  router-id 10.199.0.43
  maximum-paths 2 ecmp 2
  neighbor 10.49.158.5 peer group PE_CE_USX1
  neighbor 10.49.158.5 description UI1-N1:USX1
  neighbor 10.49.158.7 peer group PE_CE_USX1
  neighbor 10.49.158.7 description UI1-N2:USX1
!
management ssh
