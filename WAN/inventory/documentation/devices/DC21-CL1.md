...
| ------- | -------- | ---------- | ----- |
| nsho_provider_networks | DC21-CL1 | All | Enabled |
| nsho_provider_networks | DC21-CL1 |  | Enabled |
| nsho_provider_networks | DC21-CL1 | bgp backward-transition, bridge | Disabled |

#### SNMP EngineID Configuration

| Type | EngineID (Hex) | IP | Port |
| ---- | -------------- | -- | ---- |
| local | bf5aa8d7afecc301623cdbe9a261d4bc79b49fe8 | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| NETSVC_NETBRAIN_TEST | READONLY | v3 | sha | aes | - | - | bf5aa8d7afecc301623cdbe9a261d4bc79b49fe8 |
| NETSVC_NETBRAIN | READONLY | v3 | sha | aes | - | - | bf5aa8d7afecc301623cdbe9a261d4bc79b49fe8 |
| SERVICENOW | READONLY | v3 | sha | aes | - | - | bf5aa8d7afecc301623cdbe9a261d4bc79b49fe8 |
| NETSVC_NETSCOUT | READONLY | v3 | sha | aes | - | - | bf5aa8d7afecc301623cdbe9a261d4bc79b49fe8 |
| NETSVC_SPECTRUM | READONLY | v3 | sha | aes | - | - | bf5aa8d7afecc301623cdbe9a261d4bc79b49fe8 |
| sdadmin | CAPC | v3 | md5 | - | - | - | bf5aa8d7afecc301623cdbe9a261d4bc79b49fe8 |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local bf5aa8d7afecc301623cdbe9a261d4bc79b49fe8
snmp-server contact nsho_provider_networks
snmp-server location DC21-CL1
...
snmp-server user NETSVC_NETBRAIN_TEST READONLY v3 localized bf5aa8d7afecc301623cdbe9a261d4bc79b49fe8 auth sha <removed> priv aes <removed>
snmp-server user NETSVC_NETBRAIN READONLY v3 localized bf5aa8d7afecc301623cdbe9a261d4bc79b49fe8 auth sha <removed> priv aes <removed>
snmp-server user SERVICENOW READONLY v3 localized bf5aa8d7afecc301623cdbe9a261d4bc79b49fe8 auth sha <removed> priv aes <removed>
snmp-server user NETSVC_NETSCOUT READONLY v3 localized bf5aa8d7afecc301623cdbe9a261d4bc79b49fe8 auth sha <removed> priv aes <removed>
snmp-server user NETSVC_SPECTRUM READONLY v3 localized bf5aa8d7afecc301623cdbe9a261d4bc79b49fe8 auth sha <removed> priv aes <removed>
snmp-server user sdadmin CAPC v3 localized bf5aa8d7afecc301623cdbe9a261d4bc79b49fe8 auth md5 <removed>
...
| --------- | --------------- | ------------ | --------- |
| DC21_CLEAF1_2 | Vlan4094 | 172.16.0.1 | Port-Channel3 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | MLAG_PEER_DC21-CL2_Ethernet3 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 3 |
| Ethernet4 | Host1_Ethernet1 | *trunk | *10,20,30,40,50 | *- | *- | 4 |
| Ethernet5 | Host2_Ethernet1 | *trunk | *10,20,30,40,50 | *- | *- | 5 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_DC21-SP1_Ethernet1 | routed | - | 192.168.1.1/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_LINK_TO_DC21-SP2_Ethernet1 | routed | - | 192.168.1.3/31 | default | 1500 | False | - | - |
...
!
interface Ethernet1
   description P2P_LINK_TO_DC21-SP1_Ethernet1
   no shutdown
   mtu 1500
   speed forced 100g
   no switchport
...
!
interface Ethernet2
   description P2P_LINK_TO_DC21-SP2_Ethernet1
   no shutdown
   mtu 1500
   speed forced 100g
   no switchport
...
!
interface Ethernet3
   description MLAG_PEER_DC21-CL2_Ethernet3
   no shutdown
   speed 100g
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel3 | MLAG_PEER_DC21-CL2_Po3 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel3
   description MLAG_PEER_DC21-CL2_Po3
   no shutdown
   switchport
