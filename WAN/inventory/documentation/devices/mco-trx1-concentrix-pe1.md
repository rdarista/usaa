...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 10.9.181.162/28 | - |
...
| ---- | -------------- | -- | ---- |
| local | 7620bfe9e2c6ed036e006e1996e1ac3c808c75c7 | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| NETSVC_NETBRAIN_TEST | READONLY | v3 | sha | aes | - | - | 7620bfe9e2c6ed036e006e1996e1ac3c808c75c7 |
| NETSVC_NETBRAIN | READONLY | v3 | sha | aes | - | - | 7620bfe9e2c6ed036e006e1996e1ac3c808c75c7 |
| SERVICENOW | READONLY | v3 | sha | aes | - | - | 7620bfe9e2c6ed036e006e1996e1ac3c808c75c7 |
| NETSVC_SPECTRUM | READONLY | v3 | sha | aes | - | - | 7620bfe9e2c6ed036e006e1996e1ac3c808c75c7 |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 7620bfe9e2c6ed036e006e1996e1ac3c808c75c7
...
snmp-server user NETSVC_NETBRAIN_TEST READONLY v3 localized 7620bfe9e2c6ed036e006e1996e1ac3c808c75c7 auth sha <removed> priv aes <removed>
snmp-server user NETSVC_NETBRAIN READONLY v3 localized 7620bfe9e2c6ed036e006e1996e1ac3c808c75c7 auth sha <removed> priv aes <removed>
snmp-server user SERVICENOW READONLY v3 localized 7620bfe9e2c6ed036e006e1996e1ac3c808c75c7 auth sha <removed> priv aes <removed>
snmp-server user NETSVC_SPECTRUM READONLY v3 localized 7620bfe9e2c6ed036e006e1996e1ac3c808c75c7 auth sha <removed> priv aes <removed>
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | MPLS_Overlay_peering | default | 10.199.0.154/32 |
...
| ---------- | --------- | ------------------------- | -------------------- | --- | ------- | ----------------------------- | ---------------------------- | ----------------------------- | ------------- | --------------------- | ------------------ |
| 64800 | 10.199.0.154 | disabled |- | enabled | 0 | disabled | disabled | 1000000 | - | - | - |
...
| -------- | ---- | ----- | --- | ------------- | -------- |
| 10 | permit | ip address prefix-list VENDOR_PFX | local-preference 180<br>community 64800:920 64800:11712 additive | - | - |
...
description PE-PE:Po10:MCO-TRX1-CONCENTRIX-PE2:Po10
no switchport
ip address 10.199.1.166/31
mpls ldp interface
...
description PE-CE:Po11:MCO-OB1-CONCENTRIX-N1:Eth13
vrf OB1
ip address 10.9.177.232/31
!
interface Port-Channel13
description VENDOR:Po13:CONCENTRIX:Po13
no switchport
vrf 3PCC
ip address 172.27.200.1/31
mtu 9214
!
interface Ethernet2
  description VENDOR:Et2:ODCDSCCE3:Et1 
    no shutdown
    no switchport
    channel-group 13 mode active
!
interface Ethernet3
  description VENDOR:Et3:ODCDSCCE3:Et2 
    no shutdown
    no switchport
    channel-group 13 mode active
!
interface Ethernet4
  description PE-CE:Et4:MCO-OB1-CONCENTRIX-N1:Eth13
  no shutdown
  no switchport
  channel-group 11 mode active
!
interface Ethernet5
  description PE-PE:Et5:MCO-TRX1-CONCENTRIX-PE2:Et5
  no shutdown
  no switchport
...
!
interface Ethernet6
  description PE-PE:Et6:MCO-TRX1-CONCENTRIX-PE2:Et6
  no shutdown
  no switchport
  channel-group 10 mode active
  mac security profile MKA_AES_256
...
interface Ethernet37
  description P-PE:SPECTRUM:40.WCXX.000034..CHTR:Et37:447757899:DFW-TRX1-DALEQ-P3:Te0/0/0/29
  no shutdown
  mtu 9170
  no switchport
  ip address 10.199.3.14/31
  mpls ldp interface
  mac security profile MKA_AES_256
  ip ospf network point-to-point
  ip ospf authentication message-digest
...
router bgp 64800
  ...
  router-id 10.199.0.154
  maximum-paths 2 ecmp 2
  neighbor 10.9.177.233 peer group PE_CE_OB1
  neighbor 10.9.177.233 description OB1-N1:OB1
  vrf 3PCC
  rd 10.199.0.154:920
  ...
  router-id 10.199.0.154
  maximum-paths 2 ecmp 2
  neighbor 172.27.200.0 remote-as 65262
  neighbor 172.27.200.0 peer-group PE_CE_3PCC
  neighbor 172.27.200.0 description CONCENTRIX:VENDOR_DEVICE
