...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 10.50.1.21/24 | - |
...
| ---- | -------------- | -- | ---- |
| local | 4ed92bc1fe6b586d93e5ca81b539de2868bdfe00 | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| NETSVC_NETBRAIN_TEST | READONLY | v3 | sha | aes | - | - | 4ed92bc1fe6b586d93e5ca81b539de2868bdfe00 |
| NETSVC_NETBRAIN | READONLY | v3 | sha | aes | - | - | 4ed92bc1fe6b586d93e5ca81b539de2868bdfe00 |
| SERVICENOW | READONLY | v3 | sha | aes | - | - | 4ed92bc1fe6b586d93e5ca81b539de2868bdfe00 |
| NETSVC_SPECTRUM | READONLY | v3 | sha | aes | - | - | 4ed92bc1fe6b586d93e5ca81b539de2868bdfe00 |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 4ed92bc1fe6b586d93e5ca81b539de2868bdfe00
...
snmp-server user NETSVC_NETBRAIN_TEST READONLY v3 localized 4ed92bc1fe6b586d93e5ca81b539de2868bdfe00 auth sha <removed> priv aes <removed>
snmp-server user NETSVC_NETBRAIN READONLY v3 localized 4ed92bc1fe6b586d93e5ca81b539de2868bdfe00 auth sha <removed> priv aes <removed>
snmp-server user SERVICENOW READONLY v3 localized 4ed92bc1fe6b586d93e5ca81b539de2868bdfe00 auth sha <removed> priv aes <removed>
snmp-server user NETSVC_SPECTRUM READONLY v3 localized 4ed92bc1fe6b586d93e5ca81b539de2868bdfe00 auth sha <removed> priv aes <removed>
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | MPLS_Overlay_peering | default | 10.199.0.20/32 |
...
| ---------- | --------- | ------------------------- | -------------------- | --- | ------- | ----------------------------- | ---------------------------- | ----------------------------- | ------------- | --------------------- | ------------------ |
| 64800 | 10.199.0.20 | disabled |- | enabled | 0 | disabled | disabled | 1000000 | - | - | - |
...
description PE-PE:PHX-TRX1-DSVC-PE2:Po100
no switchport
...
router bgp 64800
  ...
  neighbor PE_CE_USUNT1 remote-as 64750
  ...
  neighbor PE_CE_USX1 remote-as 64750
  ...
  router-id 10.199.0.20
  maximum-paths 2 ecmp 2
  neighbor 1.1.1.1 peer group PE_CE_OB1
  neighbor 1.1.1.1 description OB1-N1:OB1
  neighbor 1.1.1.3 peer group PE_CE_OB1
  neighbor 1.1.1.3 description OB1-N2:OB1
  !
  vrf USUNT1
  rd 10.199.0.20:911
  ...
  router-id 10.199.0.20
  maximum-paths 2 ecmp 2
  neighbor 3.3.3.1 peer group PE_CE_USUNT1
  neighbor 3.3.3.1 description UI1-N1:USUNT1
  neighbor 3.3.3.3 peer group PE_CE_USUNT1
  neighbor 3.3.3.3 description UI1-N2:USUNT1
  !
  vrf USX1
  rd 10.199.0.20:914
  ...
  router-id 10.199.0.20
  maximum-paths 2 ecmp 2
  neighbor 2.2.2.1 peer group PE_CE_USX1
  neighbor 2.2.2.1 description UI1-N1:USX1
  neighbor 2.2.2.3 peer group PE_CE_USX1
  neighbor 2.2.2.3 description UI1-N2:USX1
!
management ssh
