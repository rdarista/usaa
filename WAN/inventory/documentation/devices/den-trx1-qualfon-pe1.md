...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 10.9.176.210/28 | - |
...
| ---- | -------------- | -- | ---- |
| local | 2756788e53fd368f08db287809e589c3ddd65aae | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| NETSVC_NETBRAIN_TEST | READONLY | v3 | sha | aes | - | - | 2756788e53fd368f08db287809e589c3ddd65aae |
| NETSVC_NETBRAIN | READONLY | v3 | sha | aes | - | - | 2756788e53fd368f08db287809e589c3ddd65aae |
| SERVICENOW | READONLY | v3 | sha | aes | - | - | 2756788e53fd368f08db287809e589c3ddd65aae |
| NETSVC_SPECTRUM | READONLY | v3 | sha | aes | - | - | 2756788e53fd368f08db287809e589c3ddd65aae |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 2756788e53fd368f08db287809e589c3ddd65aae
...
snmp-server user NETSVC_NETBRAIN_TEST READONLY v3 localized 2756788e53fd368f08db287809e589c3ddd65aae auth sha <removed> priv aes <removed>
snmp-server user NETSVC_NETBRAIN READONLY v3 localized 2756788e53fd368f08db287809e589c3ddd65aae auth sha <removed> priv aes <removed>
snmp-server user SERVICENOW READONLY v3 localized 2756788e53fd368f08db287809e589c3ddd65aae auth sha <removed> priv aes <removed>
snmp-server user NETSVC_SPECTRUM READONLY v3 localized 2756788e53fd368f08db287809e589c3ddd65aae auth sha <removed> priv aes <removed>
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | MPLS_Overlay_peering | default | 10.199.0.152/32 |
...
| --- | ------------------ | ----------- | -------------- | ----------------------- | --- | ---------- | ------ |
| MGMT | 0.0.0.0/0 | 10.9.176.209 | - | 1 | - | - | - |

#### Static Routes Device Configuration

```eos
!
ip route vrf MGMT 0.0.0.0/0 10.9.176.209
```
...
| ---------- | --------- | ------------------------- | -------------------- | --- | ------- | ----------------------------- | ---------------------------- | ----------------------------- | ------------- | --------------------- | ------------------ |
| 64800 | 10.199.0.152 | disabled |- | enabled | 0 | disabled | disabled | 1000000 | - | - | - |
...
| -------- | ---- | ----- | --- | ------------- | -------- |
| 10 | permit | ip address prefix-list VENDOR_PFX | local-preference 150<br>community 64800:920 64800:11710 additive | - | - |
...
router bgp 64800
  ...
  router-id 10.199.0.152
  maximum-paths 2 ecmp 2
  neighbor 10.8.249.0 remote-as 65262
