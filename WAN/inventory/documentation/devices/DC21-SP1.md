...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 192.168.0.100/24 | - |
...
| ------- | -------- | ---------- | ----- |
| nsho_provider_networks | DC21-SP1 | All | Enabled |
| nsho_provider_networks | DC21-SP1 |  | Enabled |
| nsho_provider_networks | DC21-SP1 | bgp backward-transition, bridge | Disabled |

#### SNMP EngineID Configuration

| Type | EngineID (Hex) | IP | Port |
| ---- | -------------- | -- | ---- |
| local | 4ca97c4baf227839650acabd574bc77e046ec63b | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| NETSVC_NETBRAIN_TEST | READONLY | v3 | sha | aes | - | - | 4ca97c4baf227839650acabd574bc77e046ec63b |
| NETSVC_NETBRAIN | READONLY | v3 | sha | aes | - | - | 4ca97c4baf227839650acabd574bc77e046ec63b |
| SERVICENOW | READONLY | v3 | sha | aes | - | - | 4ca97c4baf227839650acabd574bc77e046ec63b |
| NETSVC_NETSCOUT | READONLY | v3 | sha | aes | - | - | 4ca97c4baf227839650acabd574bc77e046ec63b |
| NETSVC_SPECTRUM | READONLY | v3 | sha | aes | - | - | 4ca97c4baf227839650acabd574bc77e046ec63b |
| sdadmin | CAPC | v3 | md5 | - | - | - | 4ca97c4baf227839650acabd574bc77e046ec63b |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 4ca97c4baf227839650acabd574bc77e046ec63b
snmp-server contact nsho_provider_networks
snmp-server location DC21-SP1
...
snmp-server user NETSVC_NETBRAIN_TEST READONLY v3 localized 4ca97c4baf227839650acabd574bc77e046ec63b auth sha <removed> priv aes <removed>
snmp-server user NETSVC_NETBRAIN READONLY v3 localized 4ca97c4baf227839650acabd574bc77e046ec63b auth sha <removed> priv aes <removed>
snmp-server user SERVICENOW READONLY v3 localized 4ca97c4baf227839650acabd574bc77e046ec63b auth sha <removed> priv aes <removed>
snmp-server user NETSVC_NETSCOUT READONLY v3 localized 4ca97c4baf227839650acabd574bc77e046ec63b auth sha <removed> priv aes <removed>
snmp-server user NETSVC_SPECTRUM READONLY v3 localized 4ca97c4baf227839650acabd574bc77e046ec63b auth sha <removed> priv aes <removed>
snmp-server user sdadmin CAPC v3 localized 4ca97c4baf227839650acabd574bc77e046ec63b auth md5 <removed>
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_DC21-CL1_Ethernet1 | routed | - | 192.168.1.0/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_LINK_TO_DC21-CL2_Ethernet1 | routed | - | 192.168.1.4/31 | default | 1500 | False | - | - |
| Ethernet3 | P2P_LINK_TO_DC21-CL3_Ethernet1 | routed | - | 192.168.1.8/31 | default | 1500 | False | - | - |
| Ethernet4 | P2P_LINK_TO_DC21-CL4_Ethernet1 | routed | - | 192.168.1.12/31 | default | 1500 | False | - | - |
...
!
interface Ethernet1
   description P2P_LINK_TO_DC21-CL1_Ethernet1
   no shutdown
   mtu 1500
   speed forced 100g
   no switchport
...
!
interface Ethernet2
   description P2P_LINK_TO_DC21-CL2_Ethernet1
   no shutdown
   mtu 1500
   speed forced 100g
   no switchport
...
!
interface Ethernet3
   description P2P_LINK_TO_DC21-CL3_Ethernet1
   no shutdown
   mtu 1500
   speed forced 100g
   no switchport
...
!
interface Ethernet4
   description P2P_LINK_TO_DC21-CL4_Ethernet1
   no shutdown
   mtu 1500
   speed forced 100g
   no switchport
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 192.168.100.249/32 |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 192.168.1.1 | 65000.1 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.1.5 | 65000.1 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.1.9 | 65000.3 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.1.13 | 65000.3 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
router bgp 65000.0
   ...
   update wait-install
   no bgp default ipv4-unicast
   bgp cluster-id 192.168.100.249
   timers bgp 5 15
   neighbor default send-community
   update wait-install
   ...
   neighbor 192.168.1.1 remote-as 65000.1
   neighbor 192.168.1.1 description DC21-CL1_Ethernet1
   neighbor 192.168.1.5 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.1.5 remote-as 65000.1
   neighbor 192.168.1.5 description DC21-CL2_Ethernet1
   neighbor 192.168.1.9 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.1.9 remote-as 65000.3
   neighbor 192.168.1.9 description DC21-CL3_Ethernet1
   neighbor 192.168.1.13 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.1.13 remote-as 65000.3
   neighbor 192.168.1.13 description DC21-CL4_Ethernet1
