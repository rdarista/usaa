...
| --------- | ----------- | --- | ---------- |
| Loopback0 | LSR_Router_ID | default | 10.199.0.41/32 |
...
| ---------- | --------- | ------------------------- | -------------------- | --- | ------- | ----------------------------- | ---------------------------- | ----------------------------- | ------------- | --------------------- | ------------------ |
| 64800 | 10.199.0.41 | disabled |- | enabled | 12000 | disabled | disabled | 1000000 | - | - | - |
