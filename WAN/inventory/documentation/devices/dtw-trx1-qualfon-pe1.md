...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 10.9.176.194/28 | - |
...
| ---- | -------------- | -- | ---- |
| local | 377d7e9d9b2fde0e3a4b2a0db06613e14c788703 | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| NETSVC_NETBRAIN_TEST | READONLY | v3 | sha | aes | - | - | 377d7e9d9b2fde0e3a4b2a0db06613e14c788703 |
| NETSVC_NETBRAIN | READONLY | v3 | sha | aes | - | - | 377d7e9d9b2fde0e3a4b2a0db06613e14c788703 |
| SERVICENOW | READONLY | v3 | sha | aes | - | - | 377d7e9d9b2fde0e3a4b2a0db06613e14c788703 |
| NETSVC_SPECTRUM | READONLY | v3 | sha | aes | - | - | 377d7e9d9b2fde0e3a4b2a0db06613e14c788703 |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 377d7e9d9b2fde0e3a4b2a0db06613e14c788703
...
snmp-server user NETSVC_NETBRAIN_TEST READONLY v3 localized 377d7e9d9b2fde0e3a4b2a0db06613e14c788703 auth sha <removed> priv aes <removed>
snmp-server user NETSVC_NETBRAIN READONLY v3 localized 377d7e9d9b2fde0e3a4b2a0db06613e14c788703 auth sha <removed> priv aes <removed>
snmp-server user SERVICENOW READONLY v3 localized 377d7e9d9b2fde0e3a4b2a0db06613e14c788703 auth sha <removed> priv aes <removed>
snmp-server user NETSVC_SPECTRUM READONLY v3 localized 377d7e9d9b2fde0e3a4b2a0db06613e14c788703 auth sha <removed> priv aes <removed>
...
| --- | ------------------ | ----------- | -------------- | ----------------------- | --- | ---------- | ------ |
| MGMT | 0.0.0.0/0 | 10.9.176.193 | - | 1 | - | - | - |

#### Static Routes Device Configuration

```eos
!
ip route vrf MGMT 0.0.0.0/0 10.9.176.193
```
...
| Sequence | Action |
| -------- | ------ |
| 10 | permit 172.31.110.0/23 le 32 |
| 20 | permit 100.66.144.0/20 le 32 |
| 30 | permit 172.31.20.0/24 le 32 |
...
ip prefix-list VENDOR_PFX
   seq 10 permit 172.31.110.0/23 le 32
   seq 20 permit 100.66.144.0/20 le 32
   seq 30 permit 172.31.20.0/24 le 32
```
...
interface Ethernet37
  description P-PE:ATT:IZEC522303ATI:Gi0/0/1:DFW-TRX1-DALEQ-P3:Gi0/0/0/7
  no shutdown
  mtu 9170
  no switchport
