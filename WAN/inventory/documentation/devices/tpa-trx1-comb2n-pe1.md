...
| ---- | -------------- | -- | ---- |
| local | d1ce925f0f601b6a9ea7c380a0c0e0c02ce26d2c | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| NETSVC_NETBRAIN_TEST | READONLY | v3 | sha | aes | - | - | d1ce925f0f601b6a9ea7c380a0c0e0c02ce26d2c |
| NETSVC_NETBRAIN | READONLY | v3 | sha | aes | - | - | d1ce925f0f601b6a9ea7c380a0c0e0c02ce26d2c |
| SERVICENOW | READONLY | v3 | sha | aes | - | - | d1ce925f0f601b6a9ea7c380a0c0e0c02ce26d2c |
| NETSVC_SPECTRUM | READONLY | v3 | sha | aes | - | - | d1ce925f0f601b6a9ea7c380a0c0e0c02ce26d2c |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local d1ce925f0f601b6a9ea7c380a0c0e0c02ce26d2c
...
snmp-server user NETSVC_NETBRAIN_TEST READONLY v3 localized d1ce925f0f601b6a9ea7c380a0c0e0c02ce26d2c auth sha <removed> priv aes <removed>
snmp-server user NETSVC_NETBRAIN READONLY v3 localized d1ce925f0f601b6a9ea7c380a0c0e0c02ce26d2c auth sha <removed> priv aes <removed>
snmp-server user SERVICENOW READONLY v3 localized d1ce925f0f601b6a9ea7c380a0c0e0c02ce26d2c auth sha <removed> priv aes <removed>
snmp-server user NETSVC_SPECTRUM READONLY v3 localized d1ce925f0f601b6a9ea7c380a0c0e0c02ce26d2c auth sha <removed> priv aes <removed>
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | MPLS_Overlay_peering | default | 10.199.0.42/32 |
...
description PE-PE:TPA-TRX1-COMB2N-PE2:Po100
no switchport
ip address 10.199.1.40/31
mpls ldp interface
...
interface Ethernet11
  description PE-PE:TEMP To TPA-TRX1-TFLRO-PE1:Te0/1/2
  no shutdown
  mtu 9170
  no switchport
  ip address 10.199.1.24/31
  mpls ldp interface
...
interface Ethernet36
  description PE-PE:TPA-TRX1-CRA2S-PE1:Eth36:Lumen:CID#446905447
  no shutdown
  mtu 9170
  no switchport
  ip address 10.199.1.91/31
  mpls ldp interface
  mac security profile MKA_AES_256
  ip ospf cost 1000
  ip ospf network point-to-point
...
interface Ethernet37
  description P-PE:VZE:W1E27681:::Et37::IAD-TRX1-DC21-P3:Et3
  no shutdown
  mtu 9170
  no switchport
  ip address 10.199.1.13/31
  mpls ldp interface
  mac security profile MKA_AES_256
  ip ospf cost 20000
  ip ospf network point-to-point
...
interface Ethernet47
  description PE-PE:TPA-TRX1-COM-PE2:Eth47
  no shutdown
  no switchport
...
interface Ethernet48
  description PE-PE:TPA-TRX1-COM-PE2:Eth48
  no shutdown
  no switchport
  channel-group 100 mode active
  mac security profile MKA_AES_256
...
interface Ethernet49/1
  description PE-CE:TPA-UI1-COM-N1:Eth1/1
  no shutdown
  no switchport
!
interface Ethernet49/1.2020
  description PE-CE:TPA-UI1-COM-N1:Eth1/1.2020
...
interface Ethernet49/1.2820
  description PE-CE:TPA-UI1-COM-N1:Eth1/1.2820
  encapsulation dot1q vlan 2820
  vrf USUNT1
  ip address 10.111.124.64/31
!
interface Ethernet50/1
  description PE-CE:TPA-UI1-COM-N2:Eth1/1
  no shutdown
  no switchport
!
interface Ethernet50/1.2020
  description PE-CE:TPA-UI1-COM-N2:Eth1/1.2020
  encapsulation dot1q vlan 2020
  vrf USX1
  ip address 10.49.158.2/31
  ip access-group ACL_RO_TRAFFIC_INBOUND in
!
interface Ethernet50/1.2820
  description PE-CE:TPA-UI1-COM-N2:Eth1/1.2820
  encapsulation dot1q vlan 2820
  vrf USUNT1
  ip address 10.111.124.66/31
!
interface Ethernet51/1
  description PE-CE:TPA-OB1-COM-N1:Eth53/1
  no shutdown
  no switchport
  vrf OB1
  ip address 10.9.183.44/31
!
interface Loopback0
  description MPLS_Overlay_peering
  ip address 10.199.0.42/32
...
router bgp 64800
  ...
  router-id 10.199.0.42
  maximum-paths 2 ecmp 2
  neighbor 10.9.183.45 peer group PE_CE_OB1
  neighbor 10.9.183.45 description OB1-N1:OB1
  !
  vrf USUNT1
  rd 10.199.0.42:911
  ...
  router-id 10.199.0.42
  maximum-paths 2 ecmp 2
  neighbor 10.111.124.65 peer group PE_CE_USUNT1
  neighbor 10.111.124.65 description UI1-N1:USUNT1
  neighbor 10.111.124.67 peer group PE_CE_USUNT1
  neighbor 10.111.124.67 description UI1-N2:USUNT1
  !
  vrf USX1
  rd 10.199.0.42:914
  ...
  router-id 10.199.0.42
  maximum-paths 2 ecmp 2
  neighbor 10.49.158.1 peer group PE_CE_USX1
  neighbor 10.49.158.1 description UI1-N1:USX1
  neighbor 10.49.158.3 peer group PE_CE_USX1
  neighbor 10.49.158.3 description UI1-N2:USX1
!
management ssh
