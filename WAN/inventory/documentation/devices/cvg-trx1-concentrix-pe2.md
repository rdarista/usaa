...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 10.9.181.179/28 | - |
...
| ------- | -------- | ---------- | ----- |
| nsho_provider_networks | CVG | All | Enabled |
| nsho_provider_networks | CVG |  | Enabled |
| nsho_provider_networks | CVG | bgp backward-transition, bridge | Disabled |

#### SNMP EngineID Configuration

| Type | EngineID (Hex) | IP | Port |
| ---- | -------------- | -- | ---- |
| local | 3c67e0c0629586f180a8be2a97b52f39ad35a8d6 | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| NETSVC_NETBRAIN_TEST | READONLY | v3 | sha | aes | - | - | 3c67e0c0629586f180a8be2a97b52f39ad35a8d6 |
| NETSVC_NETBRAIN | READONLY | v3 | sha | aes | - | - | 3c67e0c0629586f180a8be2a97b52f39ad35a8d6 |
| SERVICENOW | READONLY | v3 | sha | aes | - | - | 3c67e0c0629586f180a8be2a97b52f39ad35a8d6 |
| NETSVC_SPECTRUM | READONLY | v3 | sha | aes | - | - | 3c67e0c0629586f180a8be2a97b52f39ad35a8d6 |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 3c67e0c0629586f180a8be2a97b52f39ad35a8d6
snmp-server contact nsho_provider_networks
snmp-server location CVG
snmp-server vrf MGMT local-interface Management1
snmp-server view READALL ISO included
snmp-server group READONLY v3 priv read READALL
snmp-server user NETSVC_NETBRAIN_TEST READONLY v3 localized 3c67e0c0629586f180a8be2a97b52f39ad35a8d6 auth sha <removed> priv aes <removed>
snmp-server user NETSVC_NETBRAIN READONLY v3 localized 3c67e0c0629586f180a8be2a97b52f39ad35a8d6 auth sha <removed> priv aes <removed>
snmp-server user SERVICENOW READONLY v3 localized 3c67e0c0629586f180a8be2a97b52f39ad35a8d6 auth sha <removed> priv aes <removed>
snmp-server user NETSVC_SPECTRUM READONLY v3 localized 3c67e0c0629586f180a8be2a97b52f39ad35a8d6 auth sha <removed> priv aes <removed>
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | MPLS_Overlay_peering | default | 10.199.0.157/32 |
...
| --- | ------------------ | ----------- | -------------- | ----------------------- | --- | ---------- | ------ |
| MGMT | 0.0.0.0/0 | 10.9.181.177 | - | 1 | - | - | - |

#### Static Routes Device Configuration

```eos
!
ip route vrf MGMT 0.0.0.0/0 10.9.181.177
```
...
| ---------- | --------- | ------------------------- | -------------------- | --- | ------- | ----------------------------- | ---------------------------- | ----------------------------- | ------------- | --------------------- | ------------------ |
| 64800 | 10.199.0.157 | disabled |- | enabled | 0 | disabled | disabled | 1000000 | - | - | - |
...
| -------- | ---- | ----- | --- | ------------- | -------- |
| 10 | permit | ip address prefix-list VENDOR_PFX | local-preference 120<br>community 64800:920 64800:11713 additive | - | - |
...
route-map 3PCC_VENDOR_PRIORITY-1_IN permit 10
   ...
   set community 64800:920 64800:11713 additive
...
```eos
!
ip extcommunity-list regexp 3PCC permit (.*):920
!
ip extcommunity-list regexp OB1 permit 64801:1[1-3]7[0-9][0-9]
```
...
description PE-PE:Po10:CVG-TRX1-CONCENTRIX-PE1:Po10
no switchport
ip address 10.199.1.169/31
mpls ldp interface
...
description PE-CE:Po12:CVG-OB1-CONCENTRIX-N1:Et14
vrf OB1
ip address 10.9.177.238/31
!
...
!
interface Ethernet2
  description VENDOR:Et2:CDCDSCCE4:Et1 
    no shutdown
    no switchport
    channel-group 13 mode active
!
interface Ethernet3
  description VENDOR:Et3:CDCDSCCE4:Et2 
    no shutdown
    no switchport
    channel-group 13 mode active
!
interface Ethernet4
  description PE-CE:Et4:CVG-OB1-CONCENTRIX-N1:Et14
  no shutdown
  no switchport
  channel-group 12 mode active
!
interface Ethernet5
  description PE-PE:Et5:CVG-TRX1-CONCENTRIX-PE1:Et5
  no shutdown
  no switchport
...
!
interface Ethernet6
  description PE-PE:Et6:CVG-TRX1-CONCENTRIX-PE1:Et6
  no shutdown
  no switchport
  channel-group 10 mode active
  mac security profile MKA_AES_256
...
interface Ethernet37
  description P-PE:SPECTRUM:70.WCXX.000144..CHTR:Et37:WS/KGUS/088142/WXN:IAD-TRX1-DC21-P3:Et30
  no shutdown
  mtu 9170
  no switchport
  ip address 10.199.3.20/31
  mpls ldp interface
  mac security profile MKA_AES_256
  ip ospf network point-to-point
  ip ospf authentication message-digest
...
router bgp 64800
  ...
  neighbor PE_CE_3PCC fall-over bfd
  ...
  router-id 10.199.0.157
  maximum-paths 2 ecmp 2
  neighbor 10.9.177.238 peer group PE_CE_OB1
  neighbor 10.9.177.238 description OB1-N1:OB1
  vrf 3PCC
  rd 10.199.0.157:920
  ...
  router-id 10.199.0.157
  maximum-paths 2 ecmp 2
  neighbor 172.27.200.2 remote-as 65262
