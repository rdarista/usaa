...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1/1 | oob_management | oob | MGMT | 192.168.0.106/24 | - |
...
| ---- | -------------- | -- | ---- |
| local | 6b9d1ea7a07aba7a828fbab801e2494d65fdd602 | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| NETSVC_NETBRAIN_TEST | READONLY | v3 | sha | aes | - | - | 6b9d1ea7a07aba7a828fbab801e2494d65fdd602 |
| NETSVC_NETBRAIN | READONLY | v3 | sha | aes | - | - | 6b9d1ea7a07aba7a828fbab801e2494d65fdd602 |
| SERVICENOW | READONLY | v3 | sha | aes | - | - | 6b9d1ea7a07aba7a828fbab801e2494d65fdd602 |
| NETSVC_NETSCOUT | READONLY | v3 | sha | aes | - | - | 6b9d1ea7a07aba7a828fbab801e2494d65fdd602 |
| NETSVC_SPECTRUM | READONLY | v3 | sha | aes | - | - | 6b9d1ea7a07aba7a828fbab801e2494d65fdd602 |
| sdadmin | CAPC | v3 | md5 | - | - | - | 6b9d1ea7a07aba7a828fbab801e2494d65fdd602 |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 6b9d1ea7a07aba7a828fbab801e2494d65fdd602
...
snmp-server user NETSVC_NETBRAIN_TEST READONLY v3 localized 6b9d1ea7a07aba7a828fbab801e2494d65fdd602 auth sha <removed> priv aes <removed>
snmp-server user NETSVC_NETBRAIN READONLY v3 localized 6b9d1ea7a07aba7a828fbab801e2494d65fdd602 auth sha <removed> priv aes <removed>
snmp-server user SERVICENOW READONLY v3 localized 6b9d1ea7a07aba7a828fbab801e2494d65fdd602 auth sha <removed> priv aes <removed>
snmp-server user NETSVC_NETSCOUT READONLY v3 localized 6b9d1ea7a07aba7a828fbab801e2494d65fdd602 auth sha <removed> priv aes <removed>
snmp-server user NETSVC_SPECTRUM READONLY v3 localized 6b9d1ea7a07aba7a828fbab801e2494d65fdd602 auth sha <removed> priv aes <removed>
snmp-server user sdadmin CAPC v3 localized 6b9d1ea7a07aba7a828fbab801e2494d65fdd602 auth md5 <removed>
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet25 | ISP-1_101_yy_Ethernet25 | routed | - | 1.1.2.0/31 | default | - | False | - | - |
...
interface Ethernet25
   description ISP-1_101_yy_Ethernet25
   no shutdown
   no switchport
   ip address 1.1.2.0/31
```
...
!
interface Vxlan1
   description iad-rvi105-dc21-r6_VTEP
