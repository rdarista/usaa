...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 10.9.176.211/28 | - |
...
| ---- | -------------- | -- | ---- |
| local | 97b1462cd3764ef660561b2aae6ecb887f6be470 | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| NETSVC_NETBRAIN_TEST | READONLY | v3 | sha | aes | - | - | 97b1462cd3764ef660561b2aae6ecb887f6be470 |
| NETSVC_NETBRAIN | READONLY | v3 | sha | aes | - | - | 97b1462cd3764ef660561b2aae6ecb887f6be470 |
| SERVICENOW | READONLY | v3 | sha | aes | - | - | 97b1462cd3764ef660561b2aae6ecb887f6be470 |
| NETSVC_SPECTRUM | READONLY | v3 | sha | aes | - | - | 97b1462cd3764ef660561b2aae6ecb887f6be470 |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 97b1462cd3764ef660561b2aae6ecb887f6be470
...
snmp-server user NETSVC_NETBRAIN_TEST READONLY v3 localized 97b1462cd3764ef660561b2aae6ecb887f6be470 auth sha <removed> priv aes <removed>
snmp-server user NETSVC_NETBRAIN READONLY v3 localized 97b1462cd3764ef660561b2aae6ecb887f6be470 auth sha <removed> priv aes <removed>
snmp-server user SERVICENOW READONLY v3 localized 97b1462cd3764ef660561b2aae6ecb887f6be470 auth sha <removed> priv aes <removed>
snmp-server user NETSVC_SPECTRUM READONLY v3 localized 97b1462cd3764ef660561b2aae6ecb887f6be470 auth sha <removed> priv aes <removed>
...
router bgp 64800
  ...
  router-id 10.199.0.153
  maximum-paths 2 ecmp 2
  neighbor 10.8.249.2 remote-as 65262
