...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 10.9.181.178/28 | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| NETSVC_NETBRAIN_TEST | READONLY | v3 | sha | aes | - | - | c7ab9c1bf6328d4e7326597fd61c793fd738f832 |
| NETSVC_NETBRAIN | READONLY | v3 | sha | aes | - | - | c7ab9c1bf6328d4e7326597fd61c793fd738f832 |
| SERVICENOW | READONLY | v3 | sha | aes | - | - | c7ab9c1bf6328d4e7326597fd61c793fd738f832 |
| NETSVC_SPECTRUM | READONLY | v3 | sha | aes | - | - | c7ab9c1bf6328d4e7326597fd61c793fd738f832 |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local c7ab9c1bf6328d4e7326597fd61c793fd738f832
...
snmp-server user NETSVC_NETBRAIN_TEST READONLY v3 localized c7ab9c1bf6328d4e7326597fd61c793fd738f832 auth sha <removed> priv aes <removed>
snmp-server user NETSVC_NETBRAIN READONLY v3 localized c7ab9c1bf6328d4e7326597fd61c793fd738f832 auth sha <removed> priv aes <removed>
snmp-server user SERVICENOW READONLY v3 localized c7ab9c1bf6328d4e7326597fd61c793fd738f832 auth sha <removed> priv aes <removed>
snmp-server user NETSVC_SPECTRUM READONLY v3 localized c7ab9c1bf6328d4e7326597fd61c793fd738f832 auth sha <removed> priv aes <removed>
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | MPLS_Overlay_peering | default | 10.199.0.156/32 |
...
| ---------- | --------- | ------------------------- | -------------------- | --- | ------- | ----------------------------- | ---------------------------- | ----------------------------- | ------------- | --------------------- | ------------------ |
| 64800 | 10.199.0.156 | disabled |- | enabled | 0 | disabled | disabled | 1000000 | - | - | - |
...
| -------- | ---- | ----- | --- | ------------- | -------- |
| 10 | permit | ip address prefix-list VENDOR_PFX | local-preference 150<br>community 64800:920 64800:11713 additive | - | - |
...
interface Ethernet37
  description P-PE:ATT:14/KGGS/875820/SW:Et37:23076833:DFW-TRX1-DALEQ-P3:Te0/0/0/30
  no shutdown
  mtu 9170
  no switchport
...
router bgp 64800
  ...
  neighbor 10.9.177.236 description OB1-N1:OB1
  vrf 3PCC
  rd 10.199.0.156:920
