...
| ------- | -------- | ---------- | ----- |
| nsho_provider_networks | IAD-TRX1-ABVE | All | Enabled |
| nsho_provider_networks | IAD-TRX1-ABVE |  | Enabled |
| nsho_provider_networks | IAD-TRX1-ABVE | bgp backward-transition, bridge | Disabled |

#### SNMP EngineID Configuration

| Type | EngineID (Hex) | IP | Port |
| ---- | -------------- | -- | ---- |
| local | 08cf9a931edb4ccc0bd85600c7038f222e03121b | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| NETSVC_NETBRAIN_TEST | READONLY | v3 | sha | aes | - | - | 08cf9a931edb4ccc0bd85600c7038f222e03121b |
| NETSVC_NETBRAIN | READONLY | v3 | sha | aes | - | - | 08cf9a931edb4ccc0bd85600c7038f222e03121b |
| SERVICENOW | READONLY | v3 | sha | aes | - | - | 08cf9a931edb4ccc0bd85600c7038f222e03121b |
| NETSVC_NETSCOUT | READONLY | v3 | sha | aes | - | - | 08cf9a931edb4ccc0bd85600c7038f222e03121b |
| NETSVC_SPECTRUM | READONLY | v3 | sha | aes | - | - | 08cf9a931edb4ccc0bd85600c7038f222e03121b |
| sdadmin | CAPC | v3 | md5 | - | - | - | 08cf9a931edb4ccc0bd85600c7038f222e03121b |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 08cf9a931edb4ccc0bd85600c7038f222e03121b
snmp-server contact nsho_provider_networks
snmp-server location IAD-TRX1-ABVE
...
snmp-server user NETSVC_NETBRAIN_TEST READONLY v3 localized 08cf9a931edb4ccc0bd85600c7038f222e03121b auth sha <removed> priv aes <removed>
snmp-server user NETSVC_NETBRAIN READONLY v3 localized 08cf9a931edb4ccc0bd85600c7038f222e03121b auth sha <removed> priv aes <removed>
snmp-server user SERVICENOW READONLY v3 localized 08cf9a931edb4ccc0bd85600c7038f222e03121b auth sha <removed> priv aes <removed>
snmp-server user NETSVC_NETSCOUT READONLY v3 localized 08cf9a931edb4ccc0bd85600c7038f222e03121b auth sha <removed> priv aes <removed>
snmp-server user NETSVC_SPECTRUM READONLY v3 localized 08cf9a931edb4ccc0bd85600c7038f222e03121b auth sha <removed> priv aes <removed>
snmp-server user sdadmin CAPC v3 localized 08cf9a931edb4ccc0bd85600c7038f222e03121b auth md5 <removed>
...
| ---------- | --------- | ------------------------- | -------------------- | --- | ------- | ----------------------------- | ---------------------------- | ----------------------------- | ------------- | --------------------- | ------------------ |
| 64800 | 10.255.2.2 | enabled | | enabled | 12000 | disabled | disabled | - | - | - | - |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 10.199.0.1 | Inherited from peer group RR_PEERS | default | - | Inherited from peer group RR_PEERS | Inherited from peer group RR_PEERS | - | Inherited from peer group RR_PEERS | - | Inherited from peer group RR_PEERS | - | - |
| 10.199.0.2 | Inherited from peer group RR_PEERS | default | - | Inherited from peer group RR_PEERS | Inherited from peer group RR_PEERS | - | Inherited from peer group RR_PEERS | - | Inherited from peer group RR_PEERS | - | - |
...
router bgp 64800
   ...
   neighbor 10.199.0.1 peer group RR_PEERS
   neighbor 10.199.0.1 description atl_trx_dc1_pe1
   neighbor 10.199.0.2 peer group RR_PEERS
   neighbor 10.199.0.2 description atl_trx_dc1_pe2
