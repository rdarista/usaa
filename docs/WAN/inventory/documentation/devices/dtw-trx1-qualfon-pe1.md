...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 10.9.184.50/28 | - |
...
| ---- | -------------- | -- | ---- |
| local | ba110b7e1f4a025bec2a5bc111b03fca77fc1ea0 | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| NETSVC_NETBRAIN_TEST | READONLY | v3 | sha | aes | - | - | ba110b7e1f4a025bec2a5bc111b03fca77fc1ea0 |
| NETSVC_NETBRAIN | READONLY | v3 | sha | aes | - | - | ba110b7e1f4a025bec2a5bc111b03fca77fc1ea0 |
| SERVICENOW | READONLY | v3 | sha | aes | - | - | ba110b7e1f4a025bec2a5bc111b03fca77fc1ea0 |
| NETSVC_SPECTRUM | READONLY | v3 | sha | aes | - | - | ba110b7e1f4a025bec2a5bc111b03fca77fc1ea0 |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local ba110b7e1f4a025bec2a5bc111b03fca77fc1ea0
...
snmp-server user NETSVC_NETBRAIN_TEST READONLY v3 localized ba110b7e1f4a025bec2a5bc111b03fca77fc1ea0 auth sha <removed> priv aes <removed>
snmp-server user NETSVC_NETBRAIN READONLY v3 localized ba110b7e1f4a025bec2a5bc111b03fca77fc1ea0 auth sha <removed> priv aes <removed>
snmp-server user SERVICENOW READONLY v3 localized ba110b7e1f4a025bec2a5bc111b03fca77fc1ea0 auth sha <removed> priv aes <removed>
snmp-server user NETSVC_SPECTRUM READONLY v3 localized ba110b7e1f4a025bec2a5bc111b03fca77fc1ea0 auth sha <removed> priv aes <removed>
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | MPLS_Overlay_peering | default | 10.199.0.150/32 |
...
| ---------- | --------- | ------------------------- | -------------------- | --- | ------- | ----------------------------- | ---------------------------- | ----------------------------- | ------------- | --------------------- | ------------------ |
| 64800 | 10.199.0.150 | disabled |- | enabled | 0 | disabled | disabled | 1000000 | - | - | - |
...
| -------- | ---- | ----- | --- | ------------- | -------- |
| 10 | permit | ip address prefix-list VENDOR_PFX | local-preference 180<br>community 64800:920 64800:11711 additive | - | - |
...
description PE-PE:Po10:DTW-TRX1-QUALFON-PE2:Po10
no switchport
ip address 10.199.1.160/31
mpls ldp interface
...
description PE-CE:Po11:DTW-OB1-QUALFON-N1:Et13
vrf OB1
ip address 10.9.177.228/31
!
...
!
interface Ethernet5
  description PE-PE:Et5:DTW-TRX1-QUALFON-PE2:Et5
  no shutdown
  no switchport
...
!
interface Ethernet6
  description PE-PE:Et6:DTW-TRX1-QUALFON-PE2:Et6
  no shutdown
  no switchport
  channel-group 10 mode active
  mac security profile MKA_AES_256
...
interface Ethernet37
  description P-PE:ATT:IZEC522303ATI:Et37:23076833:DFW-TRX1-DALEQ-P3:Gi0/0/0/7
  no shutdown
  mtu 9170
  no switchport
  ip address 10.199.1.156/31
  mpls ldp interface
  mac security profile MKA_AES_256
  ip ospf network point-to-point
  ip ospf authentication message-digest
...
router bgp 64800
  ...
  neighbor 10.9.177.229 description OB1-N1:OB1
  vrf VNX1
  rd 10.199.0.150:920
  ...
  router-id 10.199.0.150
  maximum-paths 2 ecmp 2
  neighbor 10.16.249.0 remote-as 65262
  neighbor 10.16.249.0 peer group PE_CE_3PCC
  neighbor 10.16.249.0 description QUALFON:VENDOR_DEVICE
  neighbor 10.16.249.0 password 7 $1c$O/K5nO7RsL6PAxl7mDsL0Q==
!
management ssh
