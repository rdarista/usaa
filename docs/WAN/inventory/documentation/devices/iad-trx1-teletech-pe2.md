...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 10.9.184.99/28 | - |
...
| ---- | -------------- | -- | ---- |
| local | 9c884c868010b083e335530bfa5641c8be0bbb64 | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| NETSVC_NETBRAIN_TEST | READONLY | v3 | sha | aes | - | - | 9c884c868010b083e335530bfa5641c8be0bbb64 |
| NETSVC_NETBRAIN | READONLY | v3 | sha | aes | - | - | 9c884c868010b083e335530bfa5641c8be0bbb64 |
| SERVICENOW | READONLY | v3 | sha | aes | - | - | 9c884c868010b083e335530bfa5641c8be0bbb64 |
| NETSVC_SPECTRUM | READONLY | v3 | sha | aes | - | - | 9c884c868010b083e335530bfa5641c8be0bbb64 |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 9c884c868010b083e335530bfa5641c8be0bbb64
...
snmp-server user NETSVC_NETBRAIN_TEST READONLY v3 localized 9c884c868010b083e335530bfa5641c8be0bbb64 auth sha <removed> priv aes <removed>
snmp-server user NETSVC_NETBRAIN READONLY v3 localized 9c884c868010b083e335530bfa5641c8be0bbb64 auth sha <removed> priv aes <removed>
snmp-server user SERVICENOW READONLY v3 localized 9c884c868010b083e335530bfa5641c8be0bbb64 auth sha <removed> priv aes <removed>
snmp-server user NETSVC_SPECTRUM READONLY v3 localized 9c884c868010b083e335530bfa5641c8be0bbb64 auth sha <removed> priv aes <removed>
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | MPLS_Overlay_peering | default | 10.199.0.147/32 |
...
| --- | ------------------ | ----------- | -------------- | ----------------------- | --- | ---------- | ------ |
| MGMT | 0.0.0.0/0 | 10.9.184.97 | - | 1 | - | - | - |

#### Static Routes Device Configuration

```eos
!
ip route vrf MGMT 0.0.0.0/0 10.9.184.97
```
...
| ---------- | --------- | ------------------------- | -------------------- | --- | ------- | ----------------------------- | ---------------------------- | ----------------------------- | ------------- | --------------------- | ------------------ |
| 64800 | 10.199.0.147 | disabled |- | enabled | 0 | disabled | disabled | 1000000 | - | - | - |
...
| -------- | ---- | ----- | --- | ------------- | -------- |
| 10 | permit | ip address prefix-list VENDOR_PFX | local-preference 120<br>community 64800:920 64800:13702 additive | - | - |
...
route-map 3PCC_VENDOR_PRIORITY-1_IN permit 10
   ...
   set community 64800:920 64800:13702 additive
...
description PE-PE:Po10:IAD-TRX1-TELETECH-PE1:Po10
no switchport
ip address 10.199.1.99/31
mpls ldp interface
...
description PE-CE:Po12:IAD-OB1-TELEPERFORMANCE-N1:Eth13
vrf OB1
ip address 10.9.176.238/31
!
interface Port-Channel13
description VENDOR:Po13:TELETECH:Po13
no switchport
vrf VNX1
ip address 170.65.216.246/29
mtu 9214
!
interface Ethernet2
...
!
interface Ethernet5
  description PE-PE:Et5:IAD-TRX1-TELETECH-PE1:Et5
  no shutdown
  no switchport
...
!
interface Ethernet6
  description PE-PE:Et6:IAD-TRX1-TELETECH-PE1:Et6
  no shutdown
  no switchport
  channel-group 10 mode active
  mac security profile MKA_AES_256
...
interface Ethernet37
  description P-PE:ATT:CID#BFEC594381:Et37:447757899:IAD-TRX1-DC21-P3:ETH27
  no shutdown
  mtu 9170
  no switchport
  ip address 10.199.1.185/31
  mpls ldp interface
  mac security profile MKA_AES_256
  ip ospf network point-to-point
  ip ospf authentication message-digest
...
router bgp 64800
  ...
  router-id 10.199.0.147
  maximum-paths 2 ecmp 2
  neighbor 10.9.176.239 peer group PE_CE_OB1
  neighbor 10.9.176.239 description OB1-N1:OB1
  vrf VNX1
  rd 10.199.0.147:920
