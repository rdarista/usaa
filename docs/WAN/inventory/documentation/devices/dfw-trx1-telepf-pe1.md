...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 10.9.184.18/28 | - |
...
| ---- | -------------- | -- | ---- |
| local | 4d8c300a3a32ee226a9a0f316b677ec1dd72ede8 | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| NETSVC_NETBRAIN_TEST | READONLY | v3 | sha | aes | - | - | 4d8c300a3a32ee226a9a0f316b677ec1dd72ede8 |
| NETSVC_NETBRAIN | READONLY | v3 | sha | aes | - | - | 4d8c300a3a32ee226a9a0f316b677ec1dd72ede8 |
| SERVICENOW | READONLY | v3 | sha | aes | - | - | 4d8c300a3a32ee226a9a0f316b677ec1dd72ede8 |
| NETSVC_SPECTRUM | READONLY | v3 | sha | aes | - | - | 4d8c300a3a32ee226a9a0f316b677ec1dd72ede8 |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 4d8c300a3a32ee226a9a0f316b677ec1dd72ede8
...
snmp-server user NETSVC_NETBRAIN_TEST READONLY v3 localized 4d8c300a3a32ee226a9a0f316b677ec1dd72ede8 auth sha <removed> priv aes <removed>
snmp-server user NETSVC_NETBRAIN READONLY v3 localized 4d8c300a3a32ee226a9a0f316b677ec1dd72ede8 auth sha <removed> priv aes <removed>
snmp-server user SERVICENOW READONLY v3 localized 4d8c300a3a32ee226a9a0f316b677ec1dd72ede8 auth sha <removed> priv aes <removed>
snmp-server user NETSVC_SPECTRUM READONLY v3 localized 4d8c300a3a32ee226a9a0f316b677ec1dd72ede8 auth sha <removed> priv aes <removed>
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | MPLS_Overlay_peering | default | 10.199.0.134/32 |
...
| ---------- | --------- | ------------------------- | -------------------- | --- | ------- | ----------------------------- | ---------------------------- | ----------------------------- | ------------- | --------------------- | ------------------ |
| 64800 | 10.199.0.134 | disabled |- | enabled | 0 | disabled | disabled | 1000000 | - | - | - |
...
| -------- | ---- | ----- | --- | ------------- | -------- |
| 10 | permit | ip address prefix-list VENDOR_PFX | local-preference 180<br>community 64800:920 64800:11708 additive | - | - |
...
description PE-PE:Po10:DFW-TRX1-TELEPF-PE2:Po10
no switchport
ip address 10.199.1.150/31
mpls ldp interface
...
vrf OB1
ip address 10.9.176.228/31
!
interface Port-Channel13
description VENDOR:Po13:TELEPERFORMANCE:Po13
no switchport
vrf VNX1
ip address 10.136.194.133/29
mtu 9214
!
interface Ethernet2
...
!
interface Ethernet5
  description PE-PE:Et5:DFW-TRX1-TELEPF-PE2:Et5
  no shutdown
  no switchport
...
!
interface Ethernet6
  description PE-PE:Et6:DFW-TRX1-TELEPF-PE2:Et6
  no shutdown
  no switchport
  channel-group 10 mode active
  mac security profile MKA_AES_256
...
interface Ethernet37
  description P-PE:ATT:CID#BFEC606185ATI:Et37:447757899:SAT-TRX1-ITC2-P3:TenGigE0/0/0/14
  no shutdown
  mtu 9170
  no switchport
  ip address 10.199.1.147/31
  mpls ldp interface
  mac security profile MKA_AES_256
  ip ospf network point-to-point
  ip ospf authentication message-digest
...
router bgp 64800
  ...
  router-id 10.199.0.134
  maximum-paths 2 ecmp 2
  neighbor 10.9.176.229 peer group PE_CE_OB1
  neighbor 10.9.176.229 description OB1-N1:OB1
  vrf VNX1
  rd 10.199.0.134:920
