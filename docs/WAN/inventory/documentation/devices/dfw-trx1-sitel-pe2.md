...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 10.9.184.3/28 | - |
...
| ---- | -------------- | -- | ---- |
| local | 3bd6083edb0857d4b4e163d5db65b456994b4402 | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| NETSVC_NETBRAIN_TEST | READONLY | v3 | sha | aes | - | - | 3bd6083edb0857d4b4e163d5db65b456994b4402 |
| NETSVC_NETBRAIN | READONLY | v3 | sha | aes | - | - | 3bd6083edb0857d4b4e163d5db65b456994b4402 |
| SERVICENOW | READONLY | v3 | sha | aes | - | - | 3bd6083edb0857d4b4e163d5db65b456994b4402 |
| NETSVC_SPECTRUM | READONLY | v3 | sha | aes | - | - | 3bd6083edb0857d4b4e163d5db65b456994b4402 |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 3bd6083edb0857d4b4e163d5db65b456994b4402
...
snmp-server user NETSVC_NETBRAIN_TEST READONLY v3 localized 3bd6083edb0857d4b4e163d5db65b456994b4402 auth sha <removed> priv aes <removed>
snmp-server user NETSVC_NETBRAIN READONLY v3 localized 3bd6083edb0857d4b4e163d5db65b456994b4402 auth sha <removed> priv aes <removed>
snmp-server user SERVICENOW READONLY v3 localized 3bd6083edb0857d4b4e163d5db65b456994b4402 auth sha <removed> priv aes <removed>
snmp-server user NETSVC_SPECTRUM READONLY v3 localized 3bd6083edb0857d4b4e163d5db65b456994b4402 auth sha <removed> priv aes <removed>
...
| -------- | ---- | ----- | --- | ------------- | -------- |
| 10 | permit | ip address prefix-list VENDOR_PFX | local-preference 120<br>community 64800:920 64800:11703 additive | - | - |
