...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 10.9.184.66/28 | - |
...
| ---- | -------------- | -- | ---- |
| local | 167e90fd6a904bf7233f18a6495827cdd2d8fa7a | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| NETSVC_NETBRAIN_TEST | READONLY | v3 | sha | aes | - | - | 167e90fd6a904bf7233f18a6495827cdd2d8fa7a |
| NETSVC_NETBRAIN | READONLY | v3 | sha | aes | - | - | 167e90fd6a904bf7233f18a6495827cdd2d8fa7a |
| SERVICENOW | READONLY | v3 | sha | aes | - | - | 167e90fd6a904bf7233f18a6495827cdd2d8fa7a |
| NETSVC_SPECTRUM | READONLY | v3 | sha | aes | - | - | 167e90fd6a904bf7233f18a6495827cdd2d8fa7a |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 167e90fd6a904bf7233f18a6495827cdd2d8fa7a
...
snmp-server user NETSVC_NETBRAIN_TEST READONLY v3 localized 167e90fd6a904bf7233f18a6495827cdd2d8fa7a auth sha <removed> priv aes <removed>
snmp-server user NETSVC_NETBRAIN READONLY v3 localized 167e90fd6a904bf7233f18a6495827cdd2d8fa7a auth sha <removed> priv aes <removed>
snmp-server user SERVICENOW READONLY v3 localized 167e90fd6a904bf7233f18a6495827cdd2d8fa7a auth sha <removed> priv aes <removed>
snmp-server user NETSVC_SPECTRUM READONLY v3 localized 167e90fd6a904bf7233f18a6495827cdd2d8fa7a auth sha <removed> priv aes <removed>
...
| --- | ------------------ | ----------- | -------------- | ----------------------- | --- | ---------- | ------ |
| MGMT | 0.0.0.0/0 | 10.9.184.65 | - | 1 | - | - | - |

#### Static Routes Device Configuration

```eos
!
ip route vrf MGMT 0.0.0.0/0 10.9.184.65
```
...
| -------- | ---- | ----- | --- | ------------- | -------- |
| 10 | permit | ip address prefix-list VENDOR_PFX | local-preference 180<br>community 64800:920 64800:11704 additive | - | - |
...
route-map 3PCC_VENDOR_PRIORITY-1_IN permit 10
   ...
   set community 64800:920 64800:11704 additive
