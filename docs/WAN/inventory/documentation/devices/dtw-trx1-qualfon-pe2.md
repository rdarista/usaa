...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 10.9.184.51/28 | - |
...
| ---- | -------------- | -- | ---- |
| local | 0288041822e876a9f615b97db53ac16999d22cba | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| NETSVC_NETBRAIN_TEST | READONLY | v3 | sha | aes | - | - | 0288041822e876a9f615b97db53ac16999d22cba |
| NETSVC_NETBRAIN | READONLY | v3 | sha | aes | - | - | 0288041822e876a9f615b97db53ac16999d22cba |
| SERVICENOW | READONLY | v3 | sha | aes | - | - | 0288041822e876a9f615b97db53ac16999d22cba |
| NETSVC_SPECTRUM | READONLY | v3 | sha | aes | - | - | 0288041822e876a9f615b97db53ac16999d22cba |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 0288041822e876a9f615b97db53ac16999d22cba
...
snmp-server user NETSVC_NETBRAIN_TEST READONLY v3 localized 0288041822e876a9f615b97db53ac16999d22cba auth sha <removed> priv aes <removed>
snmp-server user NETSVC_NETBRAIN READONLY v3 localized 0288041822e876a9f615b97db53ac16999d22cba auth sha <removed> priv aes <removed>
snmp-server user SERVICENOW READONLY v3 localized 0288041822e876a9f615b97db53ac16999d22cba auth sha <removed> priv aes <removed>
snmp-server user NETSVC_SPECTRUM READONLY v3 localized 0288041822e876a9f615b97db53ac16999d22cba auth sha <removed> priv aes <removed>
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | MPLS_Overlay_peering | default | 10.199.0.151/32 |
...
| --- | ------------------ | ----------- | -------------- | ----------------------- | --- | ---------- | ------ |
| MGMT | 0.0.0.0/0 | 10.9.184.49 | - | 1 | - | - | - |

#### Static Routes Device Configuration

```eos
!
ip route vrf MGMT 0.0.0.0/0 10.9.184.49
```
...
| ---------- | --------- | ------------------------- | -------------------- | --- | ------- | ----------------------------- | ---------------------------- | ----------------------------- | ------------- | --------------------- | ------------------ |
| 64800 | 10.199.0.151 | disabled |- | enabled | 0 | disabled | disabled | 1000000 | - | - | - |
...
| -------- | ---- | ----- | --- | ------------- | -------- |
| 10 | permit | ip address prefix-list VENDOR_PFX | local-preference 170<br>community 64800:920 64800:11711 additive | - | - |
...
route-map 3PCC_VENDOR_PRIORITY-1_IN permit 10
   ...
   set community 64800:920 64800:11711 additive
...
description PE-PE:Po10:DTW-TRX1-QUALFON-PE1:Po10
no switchport
ip address 10.199.1.161/31
mpls ldp interface
...
description PE-CE:Po12:DTW-OB1-QUALFON-N1:Et13
vrf OB1
ip address 10.9.177.230/31
!
interface Port-Channel13
description VENDOR:Po13:QUALFON:Po13
no switchport
vrf VNX1
ip address 10.16.249.3/31
mtu 9214
!
interface Ethernet2
  description VENDOR:Et2:DTW:HPSCLT-01DC-01:Et1 
    no shutdown
    no switchport
    channel-group 13 mode active
!
interface Ethernet3
  description VENDOR:Et3:DTW:HPSCLT-01DC-01:Et2 
    no shutdown
    no switchport
    channel-group 13 mode active
!
interface Ethernet4
  description PE-CE:Et4:DTW-OB1-QUALFON-N1:Et13
  no shutdown
  no switchport
  channel-group 12 mode active
!
interface Ethernet5
  description PE-PE:Et5:DTW-TRX1-QUALFON-PE1:Et5
  no shutdown
  no switchport
...
!
interface Ethernet6
  description PE-PE:Et6:DTW-TRX1-QUALFON-PE1:Et6
  no shutdown
  no switchport
  channel-group 10 mode active
  mac security profile MKA_AES_256
...
interface Ethernet37
  description P-PE:VZE:W1E61263:22957597-A:Et37:23076833:IAD-TRX1-DC21-P3:Eth25
  no shutdown
  mtu 9170
  no switchport
  ip address 10.199.1.154/31
  mpls ldp interface
  mac security profile MKA_AES_256
  ip ospf network point-to-point
  ip ospf authentication message-digest
...
router bgp 64800
  ...
  router-id 10.199.0.151
  maximum-paths 2 ecmp 2
  neighbor 10.9.177.231 peer group PE_CE_OB1
  neighbor 10.9.177.231 description OB1-N1:OB1
  vrf VNX1
  rd 10.199.0.151:920
  ...
  router-id 10.199.0.151
  maximum-paths 2 ecmp 2
  neighbor 10.16.249.2 remote-as 65262
  neighbor 10.16.249.2 peer group PE_CE_3PCC
  neighbor 10.16.249.2 description QUALFON:VENDOR_DEVICE
  neighbor 10.16.249.2 password 7 $1c$O/K5nO7RsL6PAxl7mDsL0Q==
!
management ssh
