...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 10.9.184.34/28 | - |
...
| ---- | -------------- | -- | ---- |
| local | 7c942ed7e2ffbf9782ae3222fa0d83e59acf73df | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| NETSVC_NETBRAIN_TEST | READONLY | v3 | sha | aes | - | - | 7c942ed7e2ffbf9782ae3222fa0d83e59acf73df |
| NETSVC_NETBRAIN | READONLY | v3 | sha | aes | - | - | 7c942ed7e2ffbf9782ae3222fa0d83e59acf73df |
| SERVICENOW | READONLY | v3 | sha | aes | - | - | 7c942ed7e2ffbf9782ae3222fa0d83e59acf73df |
| NETSVC_SPECTRUM | READONLY | v3 | sha | aes | - | - | 7c942ed7e2ffbf9782ae3222fa0d83e59acf73df |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 7c942ed7e2ffbf9782ae3222fa0d83e59acf73df
...
snmp-server user NETSVC_NETBRAIN_TEST READONLY v3 localized 7c942ed7e2ffbf9782ae3222fa0d83e59acf73df auth sha <removed> priv aes <removed>
snmp-server user NETSVC_NETBRAIN READONLY v3 localized 7c942ed7e2ffbf9782ae3222fa0d83e59acf73df auth sha <removed> priv aes <removed>
snmp-server user SERVICENOW READONLY v3 localized 7c942ed7e2ffbf9782ae3222fa0d83e59acf73df auth sha <removed> priv aes <removed>
snmp-server user NETSVC_SPECTRUM READONLY v3 localized 7c942ed7e2ffbf9782ae3222fa0d83e59acf73df auth sha <removed> priv aes <removed>
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | MPLS_Overlay_peering | default | 10.199.0.132/32 |
...
| --- | ------------------ | ----------- | -------------- | ----------------------- | --- | ---------- | ------ |
| MGMT | 0.0.0.0/0 | 10.9.184.33 | - | 1 | - | - | - |

#### Static Routes Device Configuration

```eos
!
ip route vrf MGMT 0.0.0.0/0 10.9.184.33
```
...
| ---------- | --------- | ------------------------- | -------------------- | --- | ------- | ----------------------------- | ---------------------------- | ----------------------------- | ------------- | --------------------- | ------------------ |
| 64800 | 10.199.0.132 | disabled |- | enabled | 0 | disabled | disabled | 1000000 | - | - | - |
...
| -------- | ---- | ----- | --- | ------------- | -------- |
| 10 | permit | ip address prefix-list VENDOR_PFX | local-preference 180<br>community 64800:920 64800:11707 additive | - | - |
...
route-map 3PCC_VENDOR_PRIORITY-1_IN permit 10
   ...
   set community 64800:920 64800:11707 additive
...
description PE-PE:Po10:DEN-TRX1-TTCNT-PE2:Po10
no switchport
ip address 10.199.1.144/31
mpls ldp interface
...
description PE-CE:Po11:DEN-OB1-TELETECH-N1:Eth13
vrf OB1
ip address 10.9.176.232/31
!
interface Port-Channel13
description VENDOR:Po13:TELETECH:Po13
no switchport
vrf VNX1
ip address 170.65.122.132/29
mtu 9214
!
interface Ethernet2
  description VENDOR:Et2:TTech Denver Centennial:Et1 
    no shutdown
    no switchport
    channel-group 13 mode active
!
interface Ethernet3
  description VENDOR:Et3:TTech Denver Centennial:Et2 
    no shutdown
    no switchport
    channel-group 13 mode active
!
interface Ethernet4
  description PE-CE:Et4:DEN-OB1-TELETECH-N1:Eth13
  no shutdown
  no switchport
  channel-group 11 mode active
!
interface Ethernet5
  description PE-PE:Et5:DEN-TRX1-TTCNT-PE2:Et5
  no shutdown
  no switchport
...
!
interface Ethernet6
  description PE-PE:Et6:DEN-TRX1-TTCNT-PE2:Et6
  no shutdown
  no switchport
  channel-group 10 mode active
  mac security profile MKA_AES_256
...
interface Ethernet37
  description P-PE:VZN:CID#W1E07510:Et37:447757899:SAT-TRX1-ITC2-P3:TenGigE0/0/0/13
  no shutdown
  mtu 9170
  no switchport
  ip address 10.199.1.141/31
  mpls ldp interface
  mac security profile MKA_AES_256
  ip ospf network point-to-point
  ip ospf authentication message-digest
...
router bgp 64800
  ...
  router-id 10.199.0.132
  maximum-paths 2 ecmp 2
  neighbor 10.9.176.233 peer group PE_CE_OB1
  neighbor 10.9.176.233 description OB1-N1:OB1
  vrf VNX1
  rd 10.199.0.132:920
  ...
  router-id 10.199.0.132
  maximum-paths 2 ecmp 2
  neighbor 170.65.122.129 remote-as 14201
  neighbor 170.65.122.129 peer group PE_CE_3PCC
  neighbor 170.65.122.129 description TELETECH:VENDOR_DEVICE
  neighbor 170.65.122.129 password 7 $1c$O/K5nO7RsL6PAxl7mDsL0Q==
!
management ssh
