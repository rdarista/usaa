...
| ---- | -------------- | -- | ---- |
| local | 689640beca196f580e029dd835540d7fd985f0e1 | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| NETSVC_NETBRAIN_TEST | READONLY | v3 | sha | aes | - | - | 689640beca196f580e029dd835540d7fd985f0e1 |
| NETSVC_NETBRAIN | READONLY | v3 | sha | aes | - | - | 689640beca196f580e029dd835540d7fd985f0e1 |
| SERVICENOW | READONLY | v3 | sha | aes | - | - | 689640beca196f580e029dd835540d7fd985f0e1 |
| NETSVC_SPECTRUM | READONLY | v3 | sha | aes | - | - | 689640beca196f580e029dd835540d7fd985f0e1 |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 689640beca196f580e029dd835540d7fd985f0e1
...
snmp-server user NETSVC_NETBRAIN_TEST READONLY v3 localized 689640beca196f580e029dd835540d7fd985f0e1 auth sha <removed> priv aes <removed>
snmp-server user NETSVC_NETBRAIN READONLY v3 localized 689640beca196f580e029dd835540d7fd985f0e1 auth sha <removed> priv aes <removed>
snmp-server user SERVICENOW READONLY v3 localized 689640beca196f580e029dd835540d7fd985f0e1 auth sha <removed> priv aes <removed>
snmp-server user NETSVC_SPECTRUM READONLY v3 localized 689640beca196f580e029dd835540d7fd985f0e1 auth sha <removed> priv aes <removed>
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Port-Channel11 | - | routed | - | 10.9.176.237/31 | default | - | False | - | - |
| Port-Channel12 | - | routed | - | 10.9.176.239/31 | default | - | False | - | - |
...
| Sequence | Action |
| -------- | ------ |
| 5 | permit 10.9.184.96/28 |
| 10 | permit 10.9.176.181/32 |
...
ip prefix-list OB1_3PCC_POLICY_OUT
   seq 5 permit 10.9.184.96/28
   seq 10 permit 10.9.176.181/32
```
