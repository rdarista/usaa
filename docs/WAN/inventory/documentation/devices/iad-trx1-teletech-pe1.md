...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 10.9.184.98/28 | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| NETSVC_NETBRAIN_TEST | READONLY | v3 | sha | aes | - | - | fe4b0fa36bd3e158ef7245fe2984ba017b670a15 |
| NETSVC_NETBRAIN | READONLY | v3 | sha | aes | - | - | fe4b0fa36bd3e158ef7245fe2984ba017b670a15 |
| SERVICENOW | READONLY | v3 | sha | aes | - | - | fe4b0fa36bd3e158ef7245fe2984ba017b670a15 |
| NETSVC_SPECTRUM | READONLY | v3 | sha | aes | - | - | fe4b0fa36bd3e158ef7245fe2984ba017b670a15 |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local fe4b0fa36bd3e158ef7245fe2984ba017b670a15
...
snmp-server user NETSVC_NETBRAIN_TEST READONLY v3 localized fe4b0fa36bd3e158ef7245fe2984ba017b670a15 auth sha <removed> priv aes <removed>
snmp-server user NETSVC_NETBRAIN READONLY v3 localized fe4b0fa36bd3e158ef7245fe2984ba017b670a15 auth sha <removed> priv aes <removed>
snmp-server user SERVICENOW READONLY v3 localized fe4b0fa36bd3e158ef7245fe2984ba017b670a15 auth sha <removed> priv aes <removed>
snmp-server user NETSVC_SPECTRUM READONLY v3 localized fe4b0fa36bd3e158ef7245fe2984ba017b670a15 auth sha <removed> priv aes <removed>
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | MPLS_Overlay_peering | default | 10.199.0.146/32 |
...
| ---------- | --------- | ------------------------- | -------------------- | --- | ------- | ----------------------------- | ---------------------------- | ----------------------------- | ------------- | --------------------- | ------------------ |
| 64800 | 10.199.0.146 | disabled |- | enabled | 0 | disabled | disabled | 1000000 | - | - | - |
...
| -------- | ---- | ----- | --- | ------------- | -------- |
| 10 | permit | ip address prefix-list VENDOR_PFX | local-preference 150<br>community 64800:920 64800:13702 additive | - | - |
...
interface Ethernet37
  description P-PE:ATT:CID#BFEC586246:Et37:447757899:DFW-TRX1-DALEQ-P3:TenGigE0/0/0/10
  no shutdown
  mtu 9170
  no switchport
  ip address 10.199.1.183/31
  mpls ldp interface
  mac security profile MKA_AES_256
  ip ospf network point-to-point
  ip ospf authentication message-digest
...
router bgp 64800
  ...
  neighbor 10.9.176.237 description OB1-N1:OB1
  vrf VNX1
  rd 10.199.0.146:920
