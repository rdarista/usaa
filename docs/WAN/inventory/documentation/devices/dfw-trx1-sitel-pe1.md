...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 10.9.184.2/28 | - |
...
| ---- | -------------- | -- | ---- |
| local | 771e5caa2f04378e411e05630ef20add8ebdb6e6 | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| NETSVC_NETBRAIN_TEST | READONLY | v3 | sha | aes | - | - | 771e5caa2f04378e411e05630ef20add8ebdb6e6 |
| NETSVC_NETBRAIN | READONLY | v3 | sha | aes | - | - | 771e5caa2f04378e411e05630ef20add8ebdb6e6 |
| SERVICENOW | READONLY | v3 | sha | aes | - | - | 771e5caa2f04378e411e05630ef20add8ebdb6e6 |
| NETSVC_SPECTRUM | READONLY | v3 | sha | aes | - | - | 771e5caa2f04378e411e05630ef20add8ebdb6e6 |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 771e5caa2f04378e411e05630ef20add8ebdb6e6
...
snmp-server user NETSVC_NETBRAIN_TEST READONLY v3 localized 771e5caa2f04378e411e05630ef20add8ebdb6e6 auth sha <removed> priv aes <removed>
snmp-server user NETSVC_NETBRAIN READONLY v3 localized 771e5caa2f04378e411e05630ef20add8ebdb6e6 auth sha <removed> priv aes <removed>
snmp-server user SERVICENOW READONLY v3 localized 771e5caa2f04378e411e05630ef20add8ebdb6e6 auth sha <removed> priv aes <removed>
snmp-server user NETSVC_SPECTRUM READONLY v3 localized 771e5caa2f04378e411e05630ef20add8ebdb6e6 auth sha <removed> priv aes <removed>
...
| --- | ------------------ | ----------- | -------------- | ----------------------- | --- | ---------- | ------ |
| MGMT | 0.0.0.0/0 | 10.9.184.1 | - | 1 | - | - | - |

#### Static Routes Device Configuration

```eos
!
ip route vrf MGMT 0.0.0.0/0 10.9.184.1
```
...
| -------- | ---- | ----- | --- | ------------- | -------- |
| 10 | permit | ip address prefix-list VENDOR_PFX | local-preference 150<br>community 64800:920 64800:11703 additive | - | - |
...
route-map 3PCC_VENDOR_PRIORITY-1_IN permit 10
   ...
   set community 64800:920 64800:11703 additive
