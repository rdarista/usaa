...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 10.9.184.67/28 | - |
...
| ---- | -------------- | -- | ---- |
| local | 16c4a0005883a2f842082daa2991269dcc018cf3 | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| NETSVC_NETBRAIN_TEST | READONLY | v3 | sha | aes | - | - | 16c4a0005883a2f842082daa2991269dcc018cf3 |
| NETSVC_NETBRAIN | READONLY | v3 | sha | aes | - | - | 16c4a0005883a2f842082daa2991269dcc018cf3 |
| SERVICENOW | READONLY | v3 | sha | aes | - | - | 16c4a0005883a2f842082daa2991269dcc018cf3 |
| NETSVC_SPECTRUM | READONLY | v3 | sha | aes | - | - | 16c4a0005883a2f842082daa2991269dcc018cf3 |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 16c4a0005883a2f842082daa2991269dcc018cf3
...
snmp-server user NETSVC_NETBRAIN_TEST READONLY v3 localized 16c4a0005883a2f842082daa2991269dcc018cf3 auth sha <removed> priv aes <removed>
snmp-server user NETSVC_NETBRAIN READONLY v3 localized 16c4a0005883a2f842082daa2991269dcc018cf3 auth sha <removed> priv aes <removed>
snmp-server user SERVICENOW READONLY v3 localized 16c4a0005883a2f842082daa2991269dcc018cf3 auth sha <removed> priv aes <removed>
snmp-server user NETSVC_SPECTRUM READONLY v3 localized 16c4a0005883a2f842082daa2991269dcc018cf3 auth sha <removed> priv aes <removed>
...
| -------- | ---- | ----- | --- | ------------- | -------- |
| 10 | permit | ip address prefix-list VENDOR_PFX | local-preference 170<br>community 64800:920 64800:11704 additive | - | - |
