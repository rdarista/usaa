...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 10.9.184.82/28 | - |
...
| ------- | -------- | ---------- | ----- |
| nsho_provider_networks | SLC | All | Enabled |
| nsho_provider_networks | SLC |  | Enabled |
| nsho_provider_networks | SLC | bgp backward-transition, bridge | Disabled |

#### SNMP EngineID Configuration

| Type | EngineID (Hex) | IP | Port |
| ---- | -------------- | -- | ---- |
| local | 19e8fef557c8db9a01ea491114b351f2489da7fc | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| NETSVC_NETBRAIN_TEST | READONLY | v3 | sha | aes | - | - | 19e8fef557c8db9a01ea491114b351f2489da7fc |
| NETSVC_NETBRAIN | READONLY | v3 | sha | aes | - | - | 19e8fef557c8db9a01ea491114b351f2489da7fc |
| SERVICENOW | READONLY | v3 | sha | aes | - | - | 19e8fef557c8db9a01ea491114b351f2489da7fc |
| NETSVC_SPECTRUM | READONLY | v3 | sha | aes | - | - | 19e8fef557c8db9a01ea491114b351f2489da7fc |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 19e8fef557c8db9a01ea491114b351f2489da7fc
snmp-server contact nsho_provider_networks
snmp-server location SLC
snmp-server vrf MGMT local-interface Management1
snmp-server view READALL ISO included
snmp-server group READONLY v3 priv read READALL
snmp-server user NETSVC_NETBRAIN_TEST READONLY v3 localized 19e8fef557c8db9a01ea491114b351f2489da7fc auth sha <removed> priv aes <removed>
snmp-server user NETSVC_NETBRAIN READONLY v3 localized 19e8fef557c8db9a01ea491114b351f2489da7fc auth sha <removed> priv aes <removed>
snmp-server user SERVICENOW READONLY v3 localized 19e8fef557c8db9a01ea491114b351f2489da7fc auth sha <removed> priv aes <removed>
snmp-server user NETSVC_SPECTRUM READONLY v3 localized 19e8fef557c8db9a01ea491114b351f2489da7fc auth sha <removed> priv aes <removed>
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | MPLS_Overlay_peering | default | 10.199.0.142/32 |
...
| --- | ------------------ | ----------- | -------------- | ----------------------- | --- | ---------- | ------ |
| MGMT | 0.0.0.0/0 | 10.9.184.81 | - | 1 | - | - | - |

#### Static Routes Device Configuration

```eos
!
ip route vrf MGMT 0.0.0.0/0 10.9.184.81
```
...
| ---------- | --------- | ------------------------- | -------------------- | --- | ------- | ----------------------------- | ---------------------------- | ----------------------------- | ------------- | --------------------- | ------------------ |
| 64800 | 10.199.0.142 | disabled |- | enabled | 0 | disabled | disabled | 1000000 | - | - | - |
...
| -------- | ---- | ----- | --- | ------------- | -------- |
| 10 | permit | ip address prefix-list VENDOR_PFX | local-preference 150<br>community 64800:920 64800:11706 additive | - | - |

##### 3PCC_VENDOR_PRIORITY-1_OUT

| Sequence | Type | Match | Set | Sub-Route-Map | Continue |
| -------- | ---- | ----- | --- | ------------- | -------- |
| 10 | permit | community 3PCC | as-path prepend 64800 64800 64800 | - | - |
...
route-map 3PCC_VENDOR_PRIORITY-1_IN permit 10
   ...
   set community 64800:920 64800:11706 additive
...
description PE-PE:Po10:SLC-TRX1-TELEPF-PE2:Po10
no switchport
ip address 10.199.1.174/31
mpls ldp interface
...
description PE-CE:Po11:DFW-OB1-TELEPERFORMANCE-N1:Eth13
vrf OB1
ip address 10.9.176.224/31
!
interface Port-Channel13
description VENDOR:Po13:TELEPERFORMANCE:Po13
no switchport
vrf VNX1
ip address 10.136.60.13/29
mtu 9214
!
interface Ethernet2
  description VENDOR:Et2:TPUSA SLC:Et1 
    no shutdown
    no switchport
    channel-group 13 mode active
!
interface Ethernet3
  description VENDOR:Et3:TPUSA SLC:Et2 
    no shutdown
    no switchport
    channel-group 13 mode active
!
...
!
interface Ethernet5
  description PE-PE:Et5:SLC-TRX1-TELEPF-PE2:Et5
  no shutdown
  no switchport
...
!
interface Ethernet6
  description PE-PE:Et6:SLC-TRX1-TELEPF-PE2:Et6
  no shutdown
  no switchport
  channel-group 10 mode active
  mac security profile MKA_AES_256
...
interface Ethernet37
  description P-PE:ATT:CID#BFEC586249:Et37:447757899:SAT-TRX1-ITC2-P3:TenGigE0/0/0/9
  no shutdown
  mtu 9170
  no switchport
  ip address 10.199.1.171/31
  mpls ldp interface
  mac security profile MKA_AES_256
  ip ospf network point-to-point
  ip ospf authentication message-digest
...
router bgp 64800
  ...
  router-id 10.199.0.142
  maximum-paths 2 ecmp 2
  neighbor 10.9.176.225 peer group PE_CE_OB1
  neighbor 10.9.176.225 description OB1-N1:OB1
  vrf VNX1
  rd 10.199.0.142:920
  ...
  router-id 10.199.0.142
  maximum-paths 2 ecmp 2
  neighbor 10.136.60.11 remote-as 21597
  neighbor 10.136.60.11 peer group PE_CE_3PCC
  neighbor 10.136.60.11 description TELEPERFORMANCE:VENDOR_DEVICE
  neighbor 10.136.60.11 password 7 $1c$O/K5nO7RsL6PAxl7mDsL0Q==
!
management ssh
