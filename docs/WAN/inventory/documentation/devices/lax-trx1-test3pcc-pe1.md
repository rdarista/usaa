...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 7.7.7.7/28 | - |
...
| ------- | -------- | ---------- | ----- |
| nsho_provider_networks | LAX | All | Enabled |
| nsho_provider_networks | LAX |  | Enabled |
| nsho_provider_networks | LAX | bgp backward-transition, bridge | Disabled |

#### SNMP EngineID Configuration

| Type | EngineID (Hex) | IP | Port |
| ---- | -------------- | -- | ---- |
| local | 31ae25759e26b6fcdd3c2b03fa180b752fa92282 | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| NETSVC_NETBRAIN_TEST | READONLY | v3 | sha | aes | - | - | 31ae25759e26b6fcdd3c2b03fa180b752fa92282 |
| NETSVC_NETBRAIN | READONLY | v3 | sha | aes | - | - | 31ae25759e26b6fcdd3c2b03fa180b752fa92282 |
| SERVICENOW | READONLY | v3 | sha | aes | - | - | 31ae25759e26b6fcdd3c2b03fa180b752fa92282 |
| NETSVC_SPECTRUM | READONLY | v3 | sha | aes | - | - | 31ae25759e26b6fcdd3c2b03fa180b752fa92282 |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 31ae25759e26b6fcdd3c2b03fa180b752fa92282
...
snmp-server user NETSVC_NETBRAIN_TEST READONLY v3 localized 31ae25759e26b6fcdd3c2b03fa180b752fa92282 auth sha <removed> priv aes <removed>
snmp-server user NETSVC_NETBRAIN READONLY v3 localized 31ae25759e26b6fcdd3c2b03fa180b752fa92282 auth sha <removed> priv aes <removed>
snmp-server user SERVICENOW READONLY v3 localized 31ae25759e26b6fcdd3c2b03fa180b752fa92282 auth sha <removed> priv aes <removed>
snmp-server user NETSVC_SPECTRUM READONLY v3 localized 31ae25759e26b6fcdd3c2b03fa180b752fa92282 auth sha <removed> priv aes <removed>
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | MPLS_Overlay_peering | default | 14.14.14.1/32 |
...
| --- | ------------------ | ----------- | -------------- | ----------------------- | --- | ---------- | ------ |
| MGMT | 0.0.0.0/0 | 7.7.7.1 | - | 1 | - | - | - |

#### Static Routes Device Configuration

```eos
!
ip route vrf MGMT 0.0.0.0/0 7.7.7.1
```
...
| ---------- | --------- | ------------------------- | -------------------- | --- | ------- | ----------------------------- | ---------------------------- | ----------------------------- | ------------- | --------------------- | ------------------ |
| 64800 | 14.14.14.1 | disabled |- | enabled | 0 | disabled | disabled | 1000000 | - | - | - |
...
| Sequence | Action |
| -------- | ------ |
| 10 | permit 11.11.11.0/24 le 32 |
| 20 | permit 12.12.12.0/24 le 32 |
| 30 | permit 13.13.13.0/24 le 32 |
...
ip prefix-list VENDOR_PFX
   seq 10 permit 11.11.11.0/24 le 32
   seq 20 permit 12.12.12.0/24 le 32
   seq 30 permit 13.13.13.0/24 le 32
```
...
| -------- | ---- | ----- | --- | ------------- | -------- |
| 10 | permit | ip address prefix-list VENDOR_PFX | local-preference 180<br>community 64800:920 64800:77777 additive | - | - |

##### 3PCC_VENDOR_PRIORITY-1_OUT

| Sequence | Type | Match | Set | Sub-Route-Map | Continue |
| -------- | ---- | ----- | --- | ------------- | -------- |
| 10 | permit | community 3PCC | as-path prepend 64800 | - | - |
...
route-map 3PCC_VENDOR_PRIORITY-1_IN permit 10
   ...
   set community 64800:920 64800:77777 additive
...
description PE-PE:Po10:LAX-TRX1-TEST3PCC-PE2:Po10
no switchport
ip address 18.18.18.1/31
mpls ldp interface
...
description PE-CE:Po11:LAX-OB1-TEST_3PCC-N1:Eth13
vrf OB1
ip address 15.15.15.3/31
!
interface Port-Channel13
description VENDOR:Po13:TEST_3PCC:Po13
no switchport
vrf VNX1
ip address 16.16.16.1/31
mtu 9214
!
interface Ethernet2
  description VENDOR:Et2:LAX-TEST_3PCC-R1:Et1 
    no shutdown
    no switchport
    channel-group 13 mode active
!
interface Ethernet3
  description VENDOR:Et3:LAX-TEST_3PCC-R2:Et2 
    no shutdown
    no switchport
    channel-group 13 mode active
!
interface Ethernet4
  description PE-CE:Et4:LAX-OB1-TEST_3PCC-N1:Eth13
  no shutdown
  no switchport
  channel-group 11 mode active
!
interface Ethernet5
  description PE-PE:Et5:LAX-TRX1-TEST3PCC-PE2:Et5
  no shutdown
  no switchport
...
!
interface Ethernet6
  description PE-PE:Et6:LAX-TRX1-TEST3PCC-PE2:Et6
  no shutdown
  no switchport
  channel-group 10 mode active
  mac security profile MKA_AES_256
...
interface Ethernet37
  description P-PE:ATT:ABCDEFG123456:Et37:123456789:DFW-TRX1-DALEQ-P3:Te0/0/0/29
  no shutdown
  mtu 9170
  no switchport
  ip address 17.17.17.1/31
  mpls ldp interface
  mac security profile MKA_AES_256
  ip ospf network point-to-point
  ip ospf authentication message-digest
...
router bgp 64800
  ...
  router-id 14.14.14.1
  maximum-paths 2 ecmp 2
  neighbor 15.15.15.2 peer group PE_CE_OB1
  neighbor 15.15.15.2 description OB1-N1:OB1
  vrf VNX1
  rd 14.14.14.1:920
  ...
  router-id 14.14.14.1
  maximum-paths 2 ecmp 2
  neighbor 16.16.16.2 remote-as 88888
  neighbor 16.16.16.2 peer group PE_CE_3PCC
  neighbor 16.16.16.2 description TEST_3PCC:VENDOR_DEVICE
  neighbor 16.16.16.2 password 7 $1c$O/K5nO7RsL6PAxl7mDsL0Q==
!
management ssh
