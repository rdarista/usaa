...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 10.9.184.35/28 | - |
...
| ---- | -------------- | -- | ---- |
| local | 6a6001afa3ec07dbdfbcdf020eaadfa0c2d22236 | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| NETSVC_NETBRAIN_TEST | READONLY | v3 | sha | aes | - | - | 6a6001afa3ec07dbdfbcdf020eaadfa0c2d22236 |
| NETSVC_NETBRAIN | READONLY | v3 | sha | aes | - | - | 6a6001afa3ec07dbdfbcdf020eaadfa0c2d22236 |
| SERVICENOW | READONLY | v3 | sha | aes | - | - | 6a6001afa3ec07dbdfbcdf020eaadfa0c2d22236 |
| NETSVC_SPECTRUM | READONLY | v3 | sha | aes | - | - | 6a6001afa3ec07dbdfbcdf020eaadfa0c2d22236 |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 6a6001afa3ec07dbdfbcdf020eaadfa0c2d22236
...
snmp-server user NETSVC_NETBRAIN_TEST READONLY v3 localized 6a6001afa3ec07dbdfbcdf020eaadfa0c2d22236 auth sha <removed> priv aes <removed>
snmp-server user NETSVC_NETBRAIN READONLY v3 localized 6a6001afa3ec07dbdfbcdf020eaadfa0c2d22236 auth sha <removed> priv aes <removed>
snmp-server user SERVICENOW READONLY v3 localized 6a6001afa3ec07dbdfbcdf020eaadfa0c2d22236 auth sha <removed> priv aes <removed>
snmp-server user NETSVC_SPECTRUM READONLY v3 localized 6a6001afa3ec07dbdfbcdf020eaadfa0c2d22236 auth sha <removed> priv aes <removed>
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | MPLS_Overlay_peering | default | 10.199.0.133/32 |
...
| ---------- | --------- | ------------------------- | -------------------- | --- | ------- | ----------------------------- | ---------------------------- | ----------------------------- | ------------- | --------------------- | ------------------ |
| 64800 | 10.199.0.133 | disabled |- | enabled | 0 | disabled | disabled | 1000000 | - | - | - |
...
| -------- | ---- | ----- | --- | ------------- | -------- |
| 10 | permit | ip address prefix-list VENDOR_PFX | local-preference 170<br>community 64800:920 64800:11707 additive | - | - |
...
description PE-PE:Po10:DEN-TRX1-TTCNT-PE1:Po10
no switchport
ip address 10.199.1.145/31
mpls ldp interface
...
description PE-CE:Po12:DEN-OB1-TELETECH-N1:Eth13
vrf OB1
ip address 10.9.176.234/31
!
interface Port-Channel13
description VENDOR:Po13:TELETECH:Po13
no switchport
vrf VNX1
ip address 170.65.122.133/29
mtu 9214
!
interface Ethernet2
...
!
interface Ethernet5
  description PE-PE:Et5:DEN-TRX1-TTCNT-PE1:Et5
  no shutdown
  no switchport
...
!
interface Ethernet6
  description PE-PE:Et6:DEN-TRX1-TTCNT-PE1:Et6
  no shutdown
  no switchport
  channel-group 10 mode active
  mac security profile MKA_AES_256
...
interface Ethernet37
  description P-PE:VZN:CID#W1E07527:Et37:447757899:DFW-TRX1-DALEQ-P3:TenGigE0/0/0/13
  no shutdown
  mtu 9170
  no switchport
  ip address 10.199.1.143/31
  mpls ldp interface
  mac security profile MKA_AES_256
  ip ospf network point-to-point
  ip ospf authentication message-digest
...
router bgp 64800
  ...
  router-id 10.199.0.133
  maximum-paths 2 ecmp 2
  neighbor 10.9.176.235 peer group PE_CE_OB1
  neighbor 10.9.176.235 description OB1-N1:OB1
  vrf VNX1
  rd 10.199.0.133:920
