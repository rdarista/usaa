...
| Ethernet11 |  - | access | - | - | - | - |
| Ethernet12 |  - | access | - | - | - | - |
| Ethernet13 | DEN-TRX1-QUALFON-PE1_Ethernet4/1 | *access | *- | *- | *- | 11 |
| Ethernet14 | DEN-TRX1-QUALFON-PE2_Ethernet4/1 | *access | *- | *- | *- | 12 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Port-Channel11 | L3-PtP:OVERLAY:OB1:PE-CE | routed | - | 10.9.178.233/31 | default | - | False | - | - |
| Port-Channel12 | L3-PtP:OVERLAY:OB1:PE-CE | routed | - | 10.9.178.235/31 | default | - | False | - | - |
...
interface Ethernet1
   ...
   no shutdown
   switchport
   rofile override description mgmt interface
!
interface Ethernet2
   profile MGMT
   no shutdown
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel11 | DEN-TRX1-QUALFON-PE1 | switched | access | - | - | - | - | - | - | - |
| Port-Channel12 | DEN-TRX1-QUALFON-PE2 | switched | access | - | - | - | - | - | - | - |
...
!
interface Port-Channel11
   description DEN-TRX1-QUALFON-PE1
   no shutdown
   switchport
   bfd interval 150 min-rx 150 multiplier 150
!
interface Port-Channel12
   description DEN-TRX1-QUALFON-PE2
   no shutdown
   switchport
   bfd interval 150 min-rx 150 multiplier 150
```
