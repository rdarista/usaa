...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 10.9.184.83/28 | - |
...
| ---- | -------------- | -- | ---- |
| local | 7162b89c69888dcfbecf4f5486c9511ff30e7a73 | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| NETSVC_NETBRAIN_TEST | READONLY | v3 | sha | aes | - | - | 7162b89c69888dcfbecf4f5486c9511ff30e7a73 |
| NETSVC_NETBRAIN | READONLY | v3 | sha | aes | - | - | 7162b89c69888dcfbecf4f5486c9511ff30e7a73 |
| SERVICENOW | READONLY | v3 | sha | aes | - | - | 7162b89c69888dcfbecf4f5486c9511ff30e7a73 |
| NETSVC_SPECTRUM | READONLY | v3 | sha | aes | - | - | 7162b89c69888dcfbecf4f5486c9511ff30e7a73 |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 7162b89c69888dcfbecf4f5486c9511ff30e7a73
...
snmp-server user NETSVC_NETBRAIN_TEST READONLY v3 localized 7162b89c69888dcfbecf4f5486c9511ff30e7a73 auth sha <removed> priv aes <removed>
snmp-server user NETSVC_NETBRAIN READONLY v3 localized 7162b89c69888dcfbecf4f5486c9511ff30e7a73 auth sha <removed> priv aes <removed>
snmp-server user SERVICENOW READONLY v3 localized 7162b89c69888dcfbecf4f5486c9511ff30e7a73 auth sha <removed> priv aes <removed>
snmp-server user NETSVC_SPECTRUM READONLY v3 localized 7162b89c69888dcfbecf4f5486c9511ff30e7a73 auth sha <removed> priv aes <removed>
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | MPLS_Overlay_peering | default | 10.199.0.143/32 |
...
| ---------- | --------- | ------------------------- | -------------------- | --- | ------- | ----------------------------- | ---------------------------- | ----------------------------- | ------------- | --------------------- | ------------------ |
| 64800 | 10.199.0.143 | disabled |- | enabled | 0 | disabled | disabled | 1000000 | - | - | - |
...
| -------- | ---- | ----- | --- | ------------- | -------- |
| 10 | permit | ip address prefix-list VENDOR_PFX | local-preference 120<br>community 64800:920 64800:11706 additive | - | - |
...
description PE-PE:Po10:SLC-TRX1-TELEPF-PE1:Po10
no switchport
ip address 10.199.1.175/31
mpls ldp interface
...
vrf OB1
ip address 10.9.176.226/31
!
interface Port-Channel13
description VENDOR:Po13:TELEPERFORMANCE:Po13
no switchport
vrf VNX1
ip address 10.136.60.14/29
mtu 9214
!
interface Ethernet2
...
!
interface Ethernet5
  description PE-PE:Et5:SLC-TRX1-TELEPF-PE1:Et5
  no shutdown
  no switchport
...
!
interface Ethernet6
  description PE-PE:Et6:SLC-TRX1-TELEPF-PE1:Et6
  no shutdown
  no switchport
  channel-group 10 mode active
  mac security profile MKA_AES_256
...
interface Ethernet37
  description P-PE:ATT:CID#BFEC586248:Et37:447757899:DFW-TRX1-DALEQ-P4:TenGigE0/0/0/12
  no shutdown
  mtu 9170
  no switchport
  ip address 10.199.1.173/31
  mpls ldp interface
  mac security profile MKA_AES_256
  ip ospf network point-to-point
  ip ospf authentication message-digest
...
router bgp 64800
  ...
  router-id 10.199.0.143
  maximum-paths 2 ecmp 2
  neighbor 10.9.176.227 peer group PE_CE_OB1
  neighbor 10.9.176.227 description OB1-N1:OB1
  vrf VNX1
  rd 10.199.0.143:920
