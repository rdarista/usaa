...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 7.7.7.8/28 | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| NETSVC_NETBRAIN_TEST | READONLY | v3 | sha | aes | - | - | f97e3c591ac1d82ca58fedb479dfe9dc5265879f |
| NETSVC_NETBRAIN | READONLY | v3 | sha | aes | - | - | f97e3c591ac1d82ca58fedb479dfe9dc5265879f |
| SERVICENOW | READONLY | v3 | sha | aes | - | - | f97e3c591ac1d82ca58fedb479dfe9dc5265879f |
| NETSVC_SPECTRUM | READONLY | v3 | sha | aes | - | - | f97e3c591ac1d82ca58fedb479dfe9dc5265879f |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local f97e3c591ac1d82ca58fedb479dfe9dc5265879f
...
snmp-server user NETSVC_NETBRAIN_TEST READONLY v3 localized f97e3c591ac1d82ca58fedb479dfe9dc5265879f auth sha <removed> priv aes <removed>
snmp-server user NETSVC_NETBRAIN READONLY v3 localized f97e3c591ac1d82ca58fedb479dfe9dc5265879f auth sha <removed> priv aes <removed>
snmp-server user SERVICENOW READONLY v3 localized f97e3c591ac1d82ca58fedb479dfe9dc5265879f auth sha <removed> priv aes <removed>
snmp-server user NETSVC_SPECTRUM READONLY v3 localized f97e3c591ac1d82ca58fedb479dfe9dc5265879f auth sha <removed> priv aes <removed>
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | MPLS_Overlay_peering | default | 7.7.7.10/32 |
...
| ---------- | --------- | ------------------------- | -------------------- | --- | ------- | ----------------------------- | ---------------------------- | ----------------------------- | ------------- | --------------------- | ------------------ |
| 64800 | 7.7.7.10 | disabled |- | enabled | 0 | disabled | disabled | 1000000 | - | - | - |
...
| -------- | ---- | ----- | --- | ------------- | -------- |
| 10 | permit | ip address prefix-list VENDOR_PFX | local-preference 170<br>community 64800:920 64800:77777 additive | - | - |
