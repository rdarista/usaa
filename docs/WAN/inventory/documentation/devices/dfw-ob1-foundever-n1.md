...
| ---- | -------------- | -- | ---- |
| local | 0c90e072de2999bf31e1f6f789e8bb79cf8b5064 | - | - |
...
| ---- | ----- | ------- | -------------- | ------- | -------------- | ----------- | --------- |
| NETSVC_NETBRAIN_TEST | READONLY | v3 | sha | aes | - | - | 0c90e072de2999bf31e1f6f789e8bb79cf8b5064 |
| NETSVC_NETBRAIN | READONLY | v3 | sha | aes | - | - | 0c90e072de2999bf31e1f6f789e8bb79cf8b5064 |
| SERVICENOW | READONLY | v3 | sha | aes | - | - | 0c90e072de2999bf31e1f6f789e8bb79cf8b5064 |
| NETSVC_SPECTRUM | READONLY | v3 | sha | aes | - | - | 0c90e072de2999bf31e1f6f789e8bb79cf8b5064 |

#### SNMP Device Configuration

```eos
!
snmp-server engineID local 0c90e072de2999bf31e1f6f789e8bb79cf8b5064
...
snmp-server user NETSVC_NETBRAIN_TEST READONLY v3 localized 0c90e072de2999bf31e1f6f789e8bb79cf8b5064 auth sha <removed> priv aes <removed>
snmp-server user NETSVC_NETBRAIN READONLY v3 localized 0c90e072de2999bf31e1f6f789e8bb79cf8b5064 auth sha <removed> priv aes <removed>
snmp-server user SERVICENOW READONLY v3 localized 0c90e072de2999bf31e1f6f789e8bb79cf8b5064 auth sha <removed> priv aes <removed>
snmp-server user NETSVC_SPECTRUM READONLY v3 localized 0c90e072de2999bf31e1f6f789e8bb79cf8b5064 auth sha <removed> priv aes <removed>
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Port-Channel11 | - | routed | - | 10.9.176.245/31 | default | - | False | - | - |
| Port-Channel12 | - | routed | - | 10.9.176.247/31 | default | - | False | - | - |
...
interface Port-Channel11
   no shutdown
   no switchport
   ip address 10.9.176.245/31
!
interface Port-Channel12
   no shutdown
   no switchport
   ip address 10.9.176.247/31
```
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | Router_ID | default | 10.9.176.183/32 |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 10.9.176.244 | Inherited from peer group PE_CE_OB1 | default | - | Inherited from peer group PE_CE_OB1 | Inherited from peer group PE_CE_OB1 | - | Inherited from peer group PE_CE_OB1 | - | - | - | - |
| 10.9.176.246 | Inherited from peer group PE_CE_OB1 | default | - | Inherited from peer group PE_CE_OB1 | Inherited from peer group PE_CE_OB1 | - | Inherited from peer group PE_CE_OB1 | - | - | - | - |
...
router bgp 64801
   ...
   neighbor 10.9.176.244 peer group PE_CE_OB1
   neighbor 10.9.176.246 peer group PE_CE_OB1
   !
   address-family ipv4
      neighbor PE_CE_OB1 activate
      network 10.9.176.183/32
      network 10.9.184.0/28
```
...
| Sequence | Action |
| -------- | ------ |
| 5 | permit 10.9.184.0/28 |
| 10 | permit 10.9.176.183/32 |
...
ip prefix-list OB1_3PCC_POLICY_OUT
   seq 5 permit 10.9.184.0/28
   seq 10 permit 10.9.176.183/32
```
